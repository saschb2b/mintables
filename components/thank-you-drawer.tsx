...
import { getPrintTips, type PrintTipIcon } from "@/lib/print-tips";
...
export function ThankYouDrawer({
  ...
  const printTips = useMemo(
    () => getPrintTips(activeTab, tubeConfig, adapterConfig),
    [activeTab, tubeConfig, adapterConfig],
  );
      ...
      <Box sx={{ width: { xs: "min(100vw, 380px)", sm: 380 }, p: 3 }}>
        ...
        <Stack spacing={2.5}>
          ...
          <Box>
            ...
            >
              TubeCraft is free, open source, and runs entirely in your browser
          ...
          <Button variant="outlined" fullWidth onClick={onClose} sx={{ mt: 0.5 }}>
            Back to editing
          </Button>
        </Stack>
      </Box>
