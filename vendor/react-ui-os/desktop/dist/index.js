...
import { applyAppearance, applyPrefs, createLocalStorageAdapter } from "@react-ui-os/core";
...
var DesktopContext = createContext(null);
...
function DesktopContextProvider({
  ...
  const storage = useMemo(() => storageProp ?? createLocalStorageAdapter(), [storageProp]);
  const [prefs, setPrefs] = useState(() => readStoredPrefs(storage, baseTheme.id));
  useEffect(() => {
  ...
  const writePrefs = useCallback((next) => {
    storage.set(prefsKey(baseTheme.id), next);
    setPrefs(next);
  }, [storage, baseTheme.id]);
  const setPref = useCallback((path, value) => {
    writePrefs({
      ...prefs,
      [path]: value
    });
  }, [prefs, writePrefs]);
  const resetPref = useCallback((path_0) => {
    const {
      [path_0]: _omit,
      ...rest
    } = prefs;
  ...
  return /* @__PURE__ */ jsx(DesktopContext.Provider, { value: value_0, children });
}
...
function DesktopProvider(t0) {
  ...
  let t1;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsx2(StyleInjector, {});
    $[0] = t1;
  } else {
    t1 = $[0];
  }
  let t2;
  if ($[1] !== children) {
    t2 = /* @__PURE__ */ jsxs(WindowManagerProvider, { children: [
      t1,
      children
    ] });
    $[1] = children;
  ...
  if ($[3] !== apps || $[4] !== storage || $[5] !== t2 || $[6] !== theme) {
    t3 = /* @__PURE__ */ jsx2(DesktopContextProvider, { apps, theme, storage, children: t2 });
    $[3] = apps;
    $[4] = storage;
    $[5] = t2;
    $[6] = theme;
...
function Wallpaper() {
  ...
  const [layers, setLayers] = useState2(t0);
  ...
  if ($[14] !== fadeMs || $[15] !== layers) {
    ...
    if ($[17] !== fadeMs || $[18] !== layers.length) {
      t112 = (layer, i) => {
        ...
        return /* @__PURE__ */ jsx3("div", { onAnimationEnd: top ? handleFadeEnd : void 0, style: {
          position: "absolute",
          inset: 0,
  ...
  let t11;
  if ($[20] !== t10 || $[21] !== t9) {
    t11 = /* @__PURE__ */ jsx3("div", { ref: stackRef, style: t9, children: t10 });
    $[20] = t10;
    $[21] = t9;
    $[22] = t11;
  } else {
  ...
  if ($[23] !== wallpaper.vignette) {
    t12 = wallpaper.vignette && /* @__PURE__ */ jsx3("div", { style: {
      position: "absolute",
      inset: 0,
  ...
  if ($[25] !== t11 || $[26] !== t12 || $[27] !== t6) {
    t13 = /* @__PURE__ */ jsxs2("div", { "aria-hidden": true, style: t6, children: [
      t11,
      t12
    ] });
    $[25] = t11;
...
import { useEffect as useEffect8, useState as useState7, useSyncExternalStore as useSyncExternalStore3 } from "react";
...
import { useEffect as useEffect4, useLayoutEffect, useRef as useRef2, useState as useState3, useSyncExternalStore as useSyncExternalStore2 } from "react";
...
function ContextMenu() {
  const $ = _c5(5);
  const state = useSyncExternalStore2(subscribeContextMenu, getContextMenuState, _temp5);
  let t0;
  let t1;
  if ($[0] !== state) {
    t0 = () => {
  ...
  let t2;
  if ($[3] !== state) {
    t2 = /* @__PURE__ */ jsx4(Surface, { state });
    $[3] = state;
    $[4] = t2;
  } else {
    t2 = $[4];
...
function Surface(t0) {
  ...
  const [position, setPosition] = useState3(t1);
  ...
  const navItems = t6;
  const [focusIdx, setFocusIdx] = useState3(navItems[0]?.idx ?? -1);
  let t7;
  let t8;
  ...
  if ($[37] !== focusIdx || $[38] !== items3 || $[39] !== theme.palette.border) {
    ...
    if ($[41] !== focusIdx || $[42] !== theme.palette.border) {
      t282 = (item_2, idx_0) => {
        if (item_2.separator) {
          return /* @__PURE__ */ jsx4("div", { role: "separator", style: {
            height: 1,
        ...
        return /* @__PURE__ */ jsx4(Row, { id: menuItemId(idx_0), item: item_2, focused, onFocus: () => setFocusIdx(idx_0) }, `${item_2.label ?? "item"}-${String(idx_0)}`);
      };
      $[41] = focusIdx;
  ...
  if ($[44] !== t24 || $[45] !== t25 || $[46] !== t26 || $[47] !== t27) {
    t28 = /* @__PURE__ */ jsx4("div", { role: "presentation", onClick: handleBackdrop, onContextMenu: _temp0, style: t23, children: /* @__PURE__ */ jsx4("div", { ref: menuRef, role: "menu", tabIndex: -1, "aria-label": t24, "aria-activedescendant": t25, style: t26, children: t27 }) });
    $[44] = t24;
    $[45] = t25;
    $[46] = t26;
    $[47] = t27;
...
function Row(t0) {
  ...
  let t5;
  if ($[7] !== item.icon) {
    t5 = item.icon && /* @__PURE__ */ jsx4("span", { "aria-hidden": true, style: {
      width: 14,
      display: "inline-flex"
    }, children: item.icon });
    $[7] = item.icon;
  ...
  let t7;
  if ($[10] !== item.label) {
    t7 = /* @__PURE__ */ jsx4("span", { style: t6, children: item.label });
    $[10] = item.label;
    $[11] = t7;
  } else {
    t7 = $[11];
  ...
  if ($[12] !== item.shortcut || $[13] !== theme) {
    t8 = item.shortcut && /* @__PURE__ */ jsx4("span", { style: {
  ...
  if ($[15] !== id || $[16] !== item.disabled || $[17] !== onFocus || $[18] !== t1 || $[19] !== t4 || $[20] !== t5 || $[21] !== t7 || $[22] !== t8) {
    t9 = /* @__PURE__ */ jsxs3("button", { type: "button", id, role: "menuitem", tabIndex: -1, disabled: item.disabled, onMouseEnter: onFocus, onClick: t1, style: t4, children: [
      t5,
      t7,
      t8
    ] });
  ...
  if ($[0] !== ariaLabel || $[1] !== children || $[2] !== items3) {
    ...
    bb0: {
      ...
      if (!isValidElement(child)) {
        let t3;
        if ($[5] !== children) {
          t3 = /* @__PURE__ */ jsx5(Fragment, { children });
          $[5] = children;
          $[6] = t3;
        } else {
          t3 = $[6];
...
function Slider(t0) {
  ...
  if ($[9] !== headerStyle || $[10] !== hideValue || $[11] !== label || $[12] !== theme.palette.textPrimary || $[13] !== unit || $[14] !== value) {
    t11 = (label || !hideValue) && /* @__PURE__ */ jsxs4("div", { style: headerStyle, children: [
      label ? /* @__PURE__ */ jsx6("span", { style: {
        color: theme.palette.textPrimary
      }, children: label }) : /* @__PURE__ */ jsx6("span", {}),
      !hideValue && /* @__PURE__ */ jsxs4("span", { children: [
        String(value),
        unit ? ` ${unit}` : ""
      ] })
    ] });
  ...
  let t12;
  if ($[16] !== trackStyle) {
    t12 = /* @__PURE__ */ jsx6("span", { style: trackStyle, "aria-hidden": true });
    $[16] = trackStyle;
    $[17] = t12;
  } else {
    t12 = $[17];
  ...
  if ($[20] !== disabled || $[21] !== inputStyle || $[22] !== max || $[23] !== min || $[24] !== step || $[25] !== t13 || $[26] !== t14 || $[27] !== t15 || $[28] !== value) {
    t16 = /* @__PURE__ */ jsx6("input", { ref: inputRef, type: "range", value, min, max, step, disabled, onChange: t13, "aria-label": t14, "aria-valuetext": t15, style: inputStyle, className: "rui-slider-input" });
    $[20] = disabled;
    $[21] = inputStyle;
    $[22] = max;
    $[23] = min;
  ...
  let t17;
  if ($[30] !== t12 || $[31] !== t16) {
    t17 = /* @__PURE__ */ jsxs4("div", { style: wrapperStyle, children: [
      t12,
      t16
    ] });
    $[30] = t12;
  ...
  let t19;
  if ($[33] !== t18) {
    t19 = /* @__PURE__ */ jsx6("style", { children: t18 });
    $[33] = t18;
    $[34] = t19;
  } else {
    t19 = $[34];
  ...
  if ($[35] !== containerStyle || $[36] !== t11 || $[37] !== t17 || $[38] !== t19) {
    t20 = /* @__PURE__ */ jsxs4("div", { style: containerStyle, children: [
      t11,
      t17,
      t19
    ] });
...
function Toggle(t0) {
  ...
  if ($[9] !== description || $[10] !== label || $[11] !== theme) {
    t11 = (label || description) && /* @__PURE__ */ jsxs5("div", { style: labelBlockStyle, children: [
      label && /* @__PURE__ */ jsx7("span", { style: {
        fontSize: 12,
        fontWeight: 500,
        color: theme.palette.textPrimary
      }, children: label }),
      description && /* @__PURE__ */ jsx7("span", { style: {
        fontSize: 11,
        color: theme.palette.textSecondary
  ...
  let t14;
  if ($[16] !== thumbStyle) {
    t14 = /* @__PURE__ */ jsx7("span", { "aria-hidden": true, style: thumbStyle });
    $[16] = thumbStyle;
    $[17] = t14;
  } else {
    t14 = $[17];
  ...
  if ($[18] !== checked || $[19] !== disabled || $[20] !== switchStyle || $[21] !== t12 || $[22] !== t13 || $[23] !== t14) {
    t15 = /* @__PURE__ */ jsx7("button", { type: "button", role: "switch", "aria-checked": checked, "aria-label": t12, disabled, onClick: t13, style: switchStyle, children: t14 });
    $[18] = checked;
    $[19] = disabled;
    $[20] = switchStyle;
    $[21] = t12;
  ...
  if ($[25] !== rowStyle || $[26] !== t11 || $[27] !== t15) {
    t16 = /* @__PURE__ */ jsxs5("div", { style: rowStyle, children: [
      t11,
      t15
    ] });
    $[25] = rowStyle;
...
var useIsomorphicLayoutEffect = typeof window === "undefined" ? useEffect5 : useLayoutEffect2;
...
function Settings() {
  ...
  const [active4, setActive] = useState4(() => {
    const req = getRequestedSection();
    return req && sectionNames.includes(req.section) ? req.section : grouped2[0]?.[0] ?? "";
  });
  const [query, setQuery] = useState4("");
  const appliedNonceRef = useRef4(getRequestedSection()?.nonce ?? 0);
  const sectionNamesRef = useRef4(sectionNames);
  ...
  return /* @__PURE__ */ jsxs6("div", { ref: rootRef, style: {
    display: "flex",
    flexDirection: "column",
    gap: 14,
    color: theme.palette.textPrimary,
    ...
    /* @__PURE__ */ jsx8(SearchField, { value: query, onChange: setQuery }),
    searching ? matches.length === 0 ? /* @__PURE__ */ jsxs6("p", { style: {
      fontSize: 13,
      color: theme.palette.textSecondary,
      margin: "4px 2px"
    }, children: [
      ...
      flexDirection: "column",
      gap: 18
    }, children: matches.map(([name_3, fields_1]) => /* @__PURE__ */ jsxs6("section", { children: [
      /* @__PURE__ */ jsx8("h3", { style: {
        margin: "0 0 10px",
        fontSize: 12,
        fontWeight: 600,
        letterSpacing: 0.3,
      ...
      /* @__PURE__ */ jsx8(FieldCard, { fields: fields_1, prefs, narrow, onSet: setPref, onReset: resetPref })
    ] }, name_3)) }) : /* @__PURE__ */ jsxs6("div", { style: {
      display: "flex",
      flexDirection: narrow ? "column" : "row",
      gap: narrow ? 12 : 18
    }, children: [
      /* @__PURE__ */ jsx8(CategoryNav, { categories, activeName, onSelect: setActive, layout: narrow ? "bar" : "sidebar" }),
      /* @__PURE__ */ jsxs6("div", { style: {
        ...
        /* @__PURE__ */ jsxs6("header", { style: {
          ...
          hasPrefs && /* @__PURE__ */ jsx8("button", { type: "button", onClick: resetAll, style: {
            border: 0,
            background: "transparent",
            color: theme.palette.textSecondary,
            fontSize: 12,
        ...
        /* @__PURE__ */ jsx8(FieldCard, { fields: activeFields, prefs, narrow, onSet: setPref, onReset: resetPref })
      ] })
    ] })
  ] });
}
function SearchField(t0) {
  ...
  let t4;
  if ($[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsx8("circle", { cx: "7", cy: "7", r: "4.5", fill: "none", stroke: "currentColor", strokeWidth: "1.5" });
    t4 = /* @__PURE__ */ jsx8("line", { x1: "10.5", y1: "10.5", x2: "14", y2: "14", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" });
    $[3] = t3;
    $[4] = t4;
  } else {
    t3 = $[3];
  ...
  let t5;
  if ($[5] !== t2) {
    t5 = /* @__PURE__ */ jsxs6("svg", { width: "14", height: "14", viewBox: "0 0 16 16", "aria-hidden": true, style: t2, children: [
      t3,
      t4
    ] });
    $[5] = t2;
  ...
  if ($[21] !== t10 || $[22] !== t11 || $[23] !== t12 || $[24] !== t6 || $[25] !== t7 || $[26] !== value) {
    t13 = /* @__PURE__ */ jsx8("input", { type: "search", value, onChange: t6, onKeyDown: t7, placeholder: "Search settings", "aria-label": "Search settings", style: t10, onFocus: t11, onBlur: t12 });
    $[21] = t10;
    $[22] = t11;
    $[23] = t12;
    $[24] = t6;
  ...
  let t14;
  if ($[28] !== t13 || $[29] !== t5) {
    t14 = /* @__PURE__ */ jsxs6("div", { style: t1, children: [
      t5,
      t13
    ] });
    $[28] = t13;
...
function FieldCard(t0) {
  ...
  if ($[4] !== fields || $[5] !== narrow || $[6] !== onReset || $[7] !== onSet || $[8] !== prefs || $[9] !== theme) {
    ...
    if ($[11] !== fields.length || $[12] !== narrow || $[13] !== onReset || $[14] !== onSet || $[15] !== prefs || $[16] !== theme) {
      t52 = (t6, i) => {
        ...
        return /* @__PURE__ */ jsx8(SettingRow, { field, value, overridden, isLast: i === fields.length - 1, narrow, onChange: (v) => {
          onSet(path, v);
        }, onReset: () => {
          onReset(path);
        } }, path);
  ...
  let t5;
  if ($[18] !== t3 || $[19] !== t4) {
    t5 = /* @__PURE__ */ jsx8("div", { style: t3, children: t4 });
    $[18] = t3;
    $[19] = t4;
    $[20] = t5;
  } else {
...
function CategoryNav(t0) {
  ...
  if ($[7] !== activeName || $[8] !== bar || $[9] !== categories || $[10] !== onSelect || $[11] !== theme.motion || $[12] !== theme.palette.accent || $[13] !== theme.palette.textPrimary || $[14] !== theme.palette.textSecondary || $[15] !== theme.shape) {
    t5 = categories.map((name, index) => {
      ...
      return /* @__PURE__ */ jsx8("button", { type: "button", "aria-current": isActive, tabIndex: isActive ? 0 : -1, onClick: () => {
        onSelect(name);
      }, onKeyDown: (e) => {
  ...
  let t6;
  if ($[17] !== t4 || $[18] !== t5) {
    t6 = /* @__PURE__ */ jsx8("nav", { "aria-label": "Settings categories", style: t4, children: t5 });
    $[17] = t4;
    $[18] = t5;
    $[19] = t6;
  } else {
...
function SettingRow(t0) {
  ...
  if ($[0] !== field || $[1] !== onChange || $[2] !== value) {
    t1 = /* @__PURE__ */ jsx8(FieldControl, { field, value, onChange });
    $[0] = field;
    $[1] = onChange;
    $[2] = value;
    $[3] = t1;
  ...
  if ($[4] !== control || $[5] !== field.kind || $[6] !== stacked) {
    t2 = field.kind === "range" ? /* @__PURE__ */ jsx8("div", { style: {
  ...
  if ($[8] !== onReset || $[9] !== overridden || $[10] !== theme) {
    t3 = overridden ? /* @__PURE__ */ jsx8("button", { type: "button", onClick: onReset, style: {
      border: 0,
      background: "transparent",
      color: theme.palette.textSecondary,
      fontSize: 11,
  ...
  let t6;
  if ($[14] !== field.label) {
    t6 = /* @__PURE__ */ jsx8("div", { style: t5, children: field.label });
    $[14] = field.label;
    $[15] = t6;
  } else {
    t6 = $[15];
  ...
  if ($[16] !== field.description || $[17] !== theme) {
    t7 = field.description && /* @__PURE__ */ jsx8("div", { style: {
      fontSize: 11,
      color: theme.palette.textSecondary,
      marginTop: 2
  ...
  let t8;
  if ($[19] !== t6 || $[20] !== t7) {
    t8 = /* @__PURE__ */ jsxs6("div", { style: t4, children: [
      t6,
      t7
    ] });
    $[19] = t6;
  ...
  if ($[27] !== controlNode || $[28] !== labelBlock || $[29] !== reset || $[30] !== stacked) {
    t14 = stacked ? /* @__PURE__ */ jsxs6(Fragment2, { children: [
      /* @__PURE__ */ jsxs6("div", { style: {
        display: "flex",
        alignItems: "baseline",
        justifyContent: "space-between",
  ...
  let t15;
  if ($[32] !== t13 || $[33] !== t14) {
    t15 = /* @__PURE__ */ jsx8("div", { style: t13, children: t14 });
    $[32] = t13;
    $[33] = t14;
    $[34] = t15;
  } else {
  ...
  switch (field.kind) {
    case "color-from-palette": {
      ...
      if ($[0] !== field || $[1] !== onChange || $[2] !== t1) {
        t2 = /* @__PURE__ */ jsx8(ColorFromPaletteControl, { field, value: t1, onChange });
        $[0] = field;
        $[1] = onChange;
        $[2] = t1;
        $[3] = t2;
    ...
    case "image-pick": {
      ...
      if ($[4] !== field || $[5] !== onChange || $[6] !== t1) {
        t2 = /* @__PURE__ */ jsx8(ImagePickControl, { field, value: t1, onChange });
        $[4] = field;
        $[5] = onChange;
        $[6] = t1;
        $[7] = t2;
    ...
    case "range": {
      ...
      if ($[8] !== field || $[9] !== onChange || $[10] !== t1) {
        t2 = /* @__PURE__ */ jsx8(RangeControl, { field, value: t1, onChange });
        $[8] = field;
        $[9] = onChange;
        $[10] = t1;
        $[11] = t2;
    ...
    case "select": {
      ...
      if ($[12] !== field || $[13] !== onChange || $[14] !== t1) {
        t2 = /* @__PURE__ */ jsx8(SelectControl, { field, value: t1, onChange });
        $[12] = field;
        $[13] = onChange;
        $[14] = t1;
        $[15] = t2;
    ...
    case "toggle": {
      ...
      if ($[16] !== field || $[17] !== onChange || $[18] !== t1) {
        t2 = /* @__PURE__ */ jsx8(ToggleControl, { field, value: t1, onChange });
        $[16] = field;
        $[17] = onChange;
        $[18] = t1;
        $[19] = t2;
...
function ColorFromPaletteControl(t0) {
  ...
  if ($[4] !== field.options || $[5] !== focusIndex || $[6] !== onChange || $[7] !== theme || $[8] !== value) {
    t4 = field.options.map((color, index) => {
      ...
      return /* @__PURE__ */ jsx8("button", { type: "button", role: "radio", onClick: () => {
        onChange(color);
  ...
  if ($[10] !== field.label || $[11] !== t4) {
    t5 = /* @__PURE__ */ jsx8("div", { role: "radiogroup", "aria-label": t2, style: t3, children: t4 });
    $[10] = field.label;
    $[11] = t4;
    $[12] = t5;
  } else {
...
function ImagePickControl(t0) {
  ...
  if ($[4] !== field.options || $[5] !== focusIndex || $[6] !== onChange || $[7] !== theme || $[8] !== value) {
    t4 = field.options.map((opt, index) => {
      ...
      return /* @__PURE__ */ jsxs6("button", { type: "button", role: "radio", "aria-label": opt.label, "aria-checked": selected, tabIndex: index === focusIndex ? 0 : -1, onClick: () => {
        onChange(opt.src);
      }, onKeyDown: (e) => {
        const target = rovingTarget(e.key, index, field.options.length, "both");
        if (target < 0) {
        ...
        /* @__PURE__ */ jsx8("img", { src: opt.src, alt: opt.label, loading: "lazy", decoding: "async", style: {
          width: "100%",
          aspectRatio: "16 / 10",
          objectFit: "cover",
          borderRadius: theme.shape.small
...
function RangeControl(t0) {
  ...
  if ($[2] !== field.label || $[3] !== field.max || $[4] !== field.min || $[5] !== field.step || $[6] !== field.unit || $[7] !== t1 || $[8] !== value) {
    t2 = /* @__PURE__ */ jsx8(Slider, { value, min: field.min, max: field.max, step: field.step, onChange: t1, unit: field.unit, ariaLabel: field.label });
    $[2] = field.label;
    $[3] = field.max;
    $[4] = field.min;
    $[5] = field.step;
...
function SelectControl(t0) {
  ...
  if ($[5] !== field.options || $[6] !== focusIndex || $[7] !== onChange || $[8] !== theme.palette.accent || $[9] !== theme.palette.textPrimary || $[10] !== value) {
    t5 = field.options.map((opt, index) => {
      ...
      return /* @__PURE__ */ jsx8("button", { type: "button", role: "radio", "aria-checked": selected, tabIndex: index === focusIndex ? 0 : -1, onClick: () => {
        onChange(opt.value);
      }, onKeyDown: (e) => {
        const target = rovingTarget(e.key, index, field.options.length, "both");
        if (target < 0) {
  ...
  if ($[12] !== field.label || $[13] !== t4 || $[14] !== t5) {
    t6 = /* @__PURE__ */ jsx8("div", { role: "radiogroup", "aria-label": t2, style: t4, children: t5 });
    $[12] = field.label;
    $[13] = t4;
    $[14] = t5;
    $[15] = t6;
...
function ToggleControl(t0) {
  ...
  if ($[2] !== field.label || $[3] !== t1 || $[4] !== value) {
    t2 = /* @__PURE__ */ jsx8(Toggle, { checked: value, onChange: t1, ariaLabel: field.label });
    $[2] = field.label;
    $[3] = t1;
    $[4] = value;
    $[5] = t2;
...
function SettingsIcon(t0) {
  ...
  let t3;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t2 = /* @__PURE__ */ jsx9("path", { d: "M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" });
    t3 = /* @__PURE__ */ jsx9("circle", { cx: "12", cy: "12", r: "3" });
    $[0] = t2;
    $[1] = t3;
  } else {
    t2 = $[0];
  ...
  let t4;
  if ($[2] !== size) {
    t4 = /* @__PURE__ */ jsxs7("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.8, strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [
      t2,
      t3
    ] });
    $[2] = size;
...
function SettingsFluentIcon(t0) {
  ...
  let t3;
  if ($[1] !== size) {
    t3 = /* @__PURE__ */ jsx9("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true", children: t2 });
    $[1] = size;
    $[2] = t3;
  } else {
    t3 = $[2];
...
function useViewportMode() {
  const $ = _c11(2);
  const [mode, setMode] = useState5("regular");
  let t0;
  let t1;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t0 = () => {
...
import { Children as Children2, cloneElement as cloneElement2, isValidElement as isValidElement2, useEffect as useEffect7, useLayoutEffect as useLayoutEffect3, useRef as useRef5, useState as useState6 } from "react";
...
function Tooltip(t0) {
  ...
  let t3;
  if ($[0] !== children) {
    child = Children2.only(children);
    t3 = isValidElement2(child);
    $[0] = children;
    $[1] = child;
    $[2] = t3;
  } else {
  ...
  if (!t3) {
    let t42;
    if ($[3] !== children) {
      t42 = /* @__PURE__ */ jsx10(Fragment3, { children });
      $[3] = children;
      $[4] = t42;
    } else {
      t42 = $[4];
  ...
  if ($[5] !== disabled || $[6] !== placement || $[7] !== shortcut || $[8] !== t4 || $[9] !== text) {
    t5 = /* @__PURE__ */ jsx10(TooltipImpl, { text, shortcut, placement, disabled, child: t4 });
    $[5] = disabled;
    $[6] = placement;
    $[7] = shortcut;
    $[8] = t4;
...
function TooltipImpl({
  ...
  const showTimerRef = useRef5(null);
  const cancelShow = () => {
  ...
  const wrappedChild = cloneElement2(child, {
    onPointerEnter: (e) => {
  ...
  return /* @__PURE__ */ jsxs8(Fragment3, { children: [
    wrappedChild,
    visible && anchorRef.current && /* @__PURE__ */ jsx10(TooltipSurface, { anchor: anchorRef.current, text, shortcut, placement })
  ] });
}
function TooltipSurface(t0) {
  ...
  let t6;
  if ($[15] !== text) {
    t6 = /* @__PURE__ */ jsx10("span", { children: text });
    $[15] = text;
    $[16] = t6;
  } else {
    t6 = $[16];
  ...
  let t7;
  if ($[17] !== shortcut) {
    t7 = shortcut && /* @__PURE__ */ jsx10("span", { style: {
  ...
  if ($[19] !== surfaceStyle || $[20] !== t6 || $[21] !== t7) {
    t8 = /* @__PURE__ */ jsxs8("div", { ref: surfaceRef, role: "tooltip", style: surfaceStyle, children: [
      t6,
      t7
    ] });
    $[19] = surfaceStyle;
...
function MenuBar(t0) {
  ...
  if ($[20] !== brand || $[21] !== openBrandMenu || $[22] !== showBrand || $[23] !== theme.motion || $[24] !== theme.palette.textPrimary || $[25] !== theme.shape) {
    t11 = showBrand && brand && /* @__PURE__ */ jsx11("button", { type: "button", onClick: openBrandMenu, "aria-haspopup": "menu", "aria-label": `${brand} menu`, style: {
      appearance: "none",
      background: "transparent",
      border: 0,
      margin: 0,
  ...
  let t12;
  if ($[27] !== clockCentered) {
    t12 = clockCentered && /* @__PURE__ */ jsx11(WorkspaceIndicator, {});
    $[27] = clockCentered;
    $[28] = t12;
  } else {
    t12 = $[28];
  ...
  if ($[29] !== clockCentered || $[30] !== focusedName || $[31] !== focusedWindow?.id || $[32] !== focusedWindow?.state || $[33] !== mode || $[34] !== theme.palette.textPrimary) {
    t13 = !clockCentered && focusedName && (mode === "compact" ? /* @__PURE__ */ jsx11("span", { style: {
      fontWeight: 600,
      color: theme.palette.textPrimary
    }, children: focusedName }) : /* @__PURE__ */ jsx11(AppMenus, { name: focusedName, windowId: focusedWindow?.id ?? null, maximized: focusedWindow?.state === "maximized" }));
    $[29] = clockCentered;
    $[30] = focusedName;
    $[31] = focusedWindow?.id;
  ...
  if ($[36] !== t11 || $[37] !== t12 || $[38] !== t13) {
    t14 = /* @__PURE__ */ jsxs9("div", { style: t10, children: [
      t11,
      t12,
      t13
    ] });
  ...
  if ($[40] !== clockCentered || $[41] !== theme.palette.accent || $[42] !== theme.palette.textPrimary) {
    t15 = clockCentered && /* @__PURE__ */ jsx11("div", { style: {
      position: "absolute",
      left: "50%",
      top: 0,
      bottom: 0,
      ...
      display: "flex",
      alignItems: "center"
    }, children: /* @__PURE__ */ jsx11(SystemClock, { color: theme.palette.textPrimary, accent: theme.palette.accent }) });
    $[40] = clockCentered;
  ...
  let t17;
  if ($[45] !== clockCentered) {
    t17 = !clockCentered && /* @__PURE__ */ jsx11(WorkspaceIndicator, {});
    $[45] = clockCentered;
    $[46] = t17;
  } else {
    t17 = $[46];
  ...
  if ($[47] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t18 = /* @__PURE__ */ jsx11(StatusItems, {});
    $[47] = t18;
  } else {
    t18 = $[47];
  }
  let t19;
  if ($[48] !== clockCentered) {
    t19 = !clockCentered && /* @__PURE__ */ jsx11(SpotlightTrigger, {});
    $[48] = clockCentered;
    $[49] = t19;
  } else {
    t19 = $[49];
  ...
  if ($[50] !== theme.chrome.quickSettings) {
    t20 = theme.chrome.quickSettings && /* @__PURE__ */ jsx11(QuickSettingsTrigger, {});
  ...
  if ($[52] !== clockCentered || $[53] !== theme.palette.accent || $[54] !== theme.palette.textSecondary) {
    t21 = !clockCentered && /* @__PURE__ */ jsx11(SystemClock, { color: theme.palette.textSecondary, accent: theme.palette.accent });
    $[52] = clockCentered;
  ...
  if ($[56] !== t17 || $[57] !== t19 || $[58] !== t20 || $[59] !== t21) {
    t22 = /* @__PURE__ */ jsxs9("div", { style: t16, children: [
      t17,
      t18,
      t19,
      t20,
  ...
  if ($[61] !== t14 || $[62] !== t15 || $[63] !== t22 || $[64] !== t9) {
    t23 = /* @__PURE__ */ jsxs9("header", { "data-rui-menubar": "", style: t9, children: [
      t14,
      t15,
      t22
    ] });
...
function AppMenus(t0) {
  ...
  let t41;
  if ($[72] !== menus) {
    t41 = /* @__PURE__ */ jsx11("div", { style: t40, children: menus.map(_temp42) });
    $[72] = menus;
    $[73] = t41;
  } else {
    t41 = $[73];
...
function _temp42(menu) {
  return /* @__PURE__ */ jsx11(MenuTitle, { label: menu.label, bold: menu.bold, items: menu.items }, menu.label);
}
function _temp32() {
...
function MenuTitle(t0) {
  ...
  if ($[10] !== label || $[11] !== t1 || $[12] !== t2 || $[13] !== t3 || $[14] !== t6) {
    t7 = /* @__PURE__ */ jsx11("button", { type: "button", "aria-haspopup": "menu", "aria-label": t1, onPointerDown: t2, onMouseEnter: t3, onMouseLeave: _temp53, style: t6, children: label });
    $[10] = label;
    $[11] = t1;
    $[12] = t2;
    $[13] = t3;
...
function StatusItems() {
  const $ = _c13(5);
  const items3 = useSyncExternalStore3(subscribeStatusItems, listStatusItems, listStatusItems);
  if (items3.length === 0) {
    return null;
  }
  let t0;
  ...
  let t2;
  if ($[3] !== t1) {
    t2 = /* @__PURE__ */ jsx11("div", { role: "toolbar", "aria-label": "Status tray", style: t0, children: t1 });
    $[3] = t1;
    $[4] = t2;
  } else {
    t2 = $[4];
...
function _temp62(item) {
  return /* @__PURE__ */ jsx11(StatusItemView, { item }, item.id);
}
function StatusItemView(t0) {
  ...
  if ($[2] !== accent || $[3] !== item.badge) {
    t2 = item.badge !== void 0 && item.badge !== "" && item.badge !== 0 && /* @__PURE__ */ jsx11("span", { "aria-hidden": true, style: {
      position: "absolute",
      top: -3,
      right: -5,
      minWidth: 12,
  ...
  if ($[5] !== item.icon || $[6] !== t1 || $[7] !== t2) {
    t3 = /* @__PURE__ */ jsxs9("span", { style: t1, children: [
      item.icon,
      t2
    ] });
    $[5] = item.icon;
  ...
  if ($[17] !== body || $[18] !== item.onClick || $[19] !== t4 || $[20] !== t5 || $[21] !== t8 || $[22] !== t9) {
    t10 = /* @__PURE__ */ jsx11("button", { type: "button", onClick: item.onClick, disabled: t4, "aria-label": t5, style: t8, onMouseEnter: t9, onMouseLeave: _temp72, children: body });
    $[17] = body;
    $[18] = item.onClick;
    $[19] = t4;
    $[20] = t5;
  ...
  if ($[24] !== item.shortcut || $[25] !== item.tooltip || $[26] !== wrapped) {
    t11 = /* @__PURE__ */ jsx11(Tooltip, { text: item.tooltip, shortcut: item.shortcut, placement: "bottom", children: wrapped });
    $[24] = item.shortcut;
    $[25] = item.tooltip;
    $[26] = wrapped;
    $[27] = t11;
...
function SpotlightTrigger() {
  ...
  if ($[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsxs9("svg", { width: "15", height: "15", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", "aria-hidden": true, children: [
      /* @__PURE__ */ jsx11("circle", { cx: "6.8", cy: "6.8", r: "4.3" }),
      /* @__PURE__ */ jsx11("path", { d: "M10 10 L14 14" })
    ] });
    $[6] = t3;
  } else {
    t3 = $[6];
  ...
  let t4;
  if ($[7] !== t1 || $[8] !== t2) {
    t4 = /* @__PURE__ */ jsx11(Tooltip, { text: "Spotlight Search", shortcut: "\u2318K", placement: "bottom", children: /* @__PURE__ */ jsx11("button", { type: "button", "aria-label": "Spotlight Search", onClick: _temp82, style: t1, onMouseEnter: t2, onMouseLeave: _temp92, children: t3 }) });
    $[7] = t1;
    $[8] = t2;
    $[9] = t4;
  } else {
...
function QuickSettingsTrigger() {
  ...
  let t5;
  if ($[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsx11(NetworkGlyph, {});
    t4 = /* @__PURE__ */ jsx11(SpeakerGlyph, {});
    t5 = /* @__PURE__ */ jsx11(BatteryGlyph, {});
    $[6] = t3;
    $[7] = t4;
    $[8] = t5;
  } else {
  ...
  let t6;
  if ($[9] !== t1 || $[10] !== t2) {
    t6 = /* @__PURE__ */ jsx11(Tooltip, { text: "Quick Settings", placement: "bottom", children: /* @__PURE__ */ jsxs9("button", { type: "button", "aria-haspopup": "dialog", "aria-label": "Quick Settings", onClick: _temp02, style: t1, onMouseEnter: t2, onMouseLeave: _temp1, children: [
      t3,
      t4,
      t5
    ] }) });
...
function NetworkGlyph() {
  ...
  let t0;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxs9("svg", { width: 14, height: 14, viewBox: "0 0 14 14", fill: "currentColor", "aria-hidden": true, children: [
      /* @__PURE__ */ jsx11("rect", { x: "1", y: "9", width: "2.4", height: "4", rx: "0.6" }),
      /* @__PURE__ */ jsx11("rect", { x: "4.8", y: "6.5", width: "2.4", height: "6.5", rx: "0.6" }),
      /* @__PURE__ */ jsx11("rect", { x: "8.6", y: "3.5", width: "2.4", height: "9.5", rx: "0.6" })
    ] });
    $[0] = t0;
  } else {
    t0 = $[0];
...
function SpeakerGlyph() {
  ...
  let t0;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxs9("svg", { width: 14, height: 14, viewBox: "0 0 14 14", "aria-hidden": true, fill: "none", stroke: "currentColor", strokeWidth: 1.1, strokeLinejoin: "round", children: [
      /* @__PURE__ */ jsx11("path", { d: "M2 5 H4 L7.5 2.5 V11.5 L4 9 H2 Z", fill: "currentColor", stroke: "none" }),
      /* @__PURE__ */ jsx11("path", { d: "M9.5 5 Q11 7 9.5 9", strokeLinecap: "round" })
    ] });
    $[0] = t0;
  } else {
    t0 = $[0];
...
function BatteryGlyph() {
  ...
  let t0;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxs9("svg", { width: 16, height: 14, viewBox: "0 0 16 14", "aria-hidden": true, fill: "none", stroke: "currentColor", strokeWidth: 1.1, children: [
      /* @__PURE__ */ jsx11("rect", { x: "1", y: "4", width: "11", height: "6", rx: "1.4" }),
      /* @__PURE__ */ jsx11("rect", { x: "3", y: "6", width: "6", height: "2", rx: "0.5", fill: "currentColor", stroke: "none" }),
      /* @__PURE__ */ jsx11("rect", { x: "13", y: "5.6", width: "1.6", height: "2.8", rx: "0.6", fill: "currentColor", stroke: "none" })
    ] });
    $[0] = t0;
  } else {
    t0 = $[0];
...
function WorkspaceIndicator() {
  ...
  if ($[1] !== activeId || $[2] !== switchWorkspace || $[3] !== theme || $[4] !== workspaces) {
    ...
    if ($[6] !== activeId || $[7] !== switchWorkspace || $[8] !== theme || $[9] !== workspaces.length) {
      t22 = (id, idx) => {
        ...
        return /* @__PURE__ */ jsx11(Tooltip, { text: `Workspace ${String(idx + 1)}`, shortcut: `\u2303\u2325${idx === 0 ? "1" : idx === workspaces.length - 1 ? String(workspaces.length) : String(idx + 1)}`, placement: "bottom", children: /* @__PURE__ */ jsx11("button", { type: "button", role: "tab", "aria-selected": isActive, "aria-label": `Workspace ${String(idx + 1)}`, onClick: () => switchWorkspace(id), style: {
          appearance: "none",
          border: 0,
          background: "transparent",
          padding: 4,
          ...
          borderRadius: 999,
          display: "inline-flex"
        }, children: /* @__PURE__ */ jsx11("span", { "aria-hidden": true, style: {
  ...
  let t2;
  if ($[11] !== t1) {
    t2 = /* @__PURE__ */ jsx11("div", { role: "tablist", "aria-label": "Workspaces", style: t0, children: t1 });
    $[11] = t1;
    $[12] = t2;
  } else {
    t2 = $[12];
...
function SystemClock(t0) {
  ...
  const [now, setNow] = useState7(null);
  let t1;
  let t2;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = () => {
  ...
  if ($[15] !== accent || $[16] !== unreadCount) {
    t11 = unreadCount > 0 && /* @__PURE__ */ jsx11("span", { "aria-hidden": true, style: {
      width: 6,
      height: 6,
      borderRadius: "50%",
      background: accent
  ...
  if ($[18] !== day || $[19] !== t10 || $[20] !== t11 || $[21] !== t7 || $[22] !== t9 || $[23] !== time) {
    t12 = /* @__PURE__ */ jsxs9("button", { type: "button", onClick: _temp102, "aria-label": t7, style: t9, onMouseEnter: t10, onMouseLeave: _temp11, children: [
      t11,
      day,
      " ",
      time
  ...
  let t13;
  if ($[25] !== t12 || $[26] !== t6) {
    t13 = /* @__PURE__ */ jsx11(Tooltip, { text: t6, placement: "bottom", children: t12 });
    $[25] = t12;
    $[26] = t6;
    $[27] = t13;
  } else {
...
import { useCallback as useCallback2, useEffect as useEffect9, useRef as useRef6, useState as useState8, useSyncExternalStore as useSyncExternalStore4 } from "react";
import { markAllNotificationsRead, useNotifications as useNotifications2, useWindowManager as useWindowManager2, windowIdOf } from "@react-ui-os/core";
...
function useBackdropDisplacementSupported() {
  const $ = _c14(2);
  const [ok, setOk] = useState8(false);
  let t0;
  let t1;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t0 = () => {
...
function Dock() {
  ...
  const [viewLen, setViewLen] = useState8(null);
  useEffect9(() => {
  ...
  const span = base + gap;
  const runningCount = isBar ? apps.filter((app) => windows.some((w) => w.id === windowIdOf({
    kind: "app",
    appId: app.id
  }))).length : 0;
  ...
  const revealedRef = useRef6(revealed);
  revealedRef.current = revealed;
  const [sizes2, setSizes] = useState8(() => apps.map(() => base));
  const sizesRef = useRef6(sizes2);
  const cursorRef = useRef6(null);
  const rafRef = useRef6(null);
  const lastRef = useRef6(0);
  const geomRef = useRef6({
    count,
    base,
    span,
    vertical,
  ...
  const hoveredIsLabeled = labeled && focusedApp !== void 0 && windows.some((w_0) => w_0.id === windowIdOf({
    kind: "app",
    appId: focusedApp.id
  }));
  ...
  return /* @__PURE__ */ jsxs10("nav", { "aria-label": "App dock", "data-dock-position": position, "data-rui-dock": "", onPointerMove: handleMove, onPointerLeave: handleLeave, onContextMenu: taskbarMenu ? handleBarContextMenu : void 0, style: navStyle, children: [
    theme.chrome.liquidGlass ? /* @__PURE__ */ jsx12("svg", { "aria-hidden": true, width: "0", height: "0", style: {
      position: "absolute",
      width: 0,
      height: 0,
      pointerEvents: "none"
    }, children: /* @__PURE__ */ jsxs10("filter", { id: "rui-liquid-glass", x: "0", y: "0", width: "100%", height: "100%", children: [
      /* @__PURE__ */ jsx12("feTurbulence", { type: "fractalNoise", baseFrequency: "0.01 0.012", numOctaves: "2", seed: "4", result: "noise" }),
      /* @__PURE__ */ jsx12("feDisplacementMap", { in: "SourceGraphic", in2: "noise", scale: "20", xChannelSelector: "R", yChannelSelector: "G" })
    ] }) }) : null,
    launcherInline && /* @__PURE__ */ jsx12(StartButton, { inline: true, vertical, tile: base, iconScale }),
    launcherInline && taskView && /* @__PURE__ */ jsx12(TaskViewButton, { tile: base, iconScale }),
    apps.map((app_1, i_4) => /* @__PURE__ */ jsx12(DockTile, { app: app_1, position, bar: isBar, size: Math.round(sizes2[i_4] ?? base), base, iconScale, labeled }, app_1.id)),
    showLabel && focusedApp ? /* @__PURE__ */ jsx12("span", { "aria-hidden": true, style: {
      position: "absolute",
    ...
    launcherTrailing && /* @__PURE__ */ jsx12(StartButton, { vertical, trailing: true, tile: base, iconScale }),
    showTray && /* @__PURE__ */ jsx12(TaskbarTray, { vertical, trailingInset: showDesktop ? SHOW_DESKTOP_WIDTH : 0 }),
    showDesktop && /* @__PURE__ */ jsx12(ShowDesktopButton, { vertical })
  ] });
}
function StartButton(t0) {
  ...
  const theme = useTheme();
  const reducedMotion = useReducedMotion();
  const launcherOpen = useSyncExternalStore4(subscribeLauncherOpen, getLauncherOpen, _temp24);
  const hover = `${theme.palette.textPrimary}14`;
  ...
  if ($[24] !== glyph || $[25] !== theme.chrome.launcher || $[26] !== theme.chrome.launcherIcon || $[27] !== theme.chrome.launcherIconSrc || $[28] !== theme.palette.textPrimary) {
    t12 = theme.chrome.launcherIconSrc ? /* @__PURE__ */ jsx12("span", { "aria-hidden": true, style: {
      width: glyph,
      height: glyph,
    ...
    } }) : /* @__PURE__ */ jsx12(LauncherGlyph, { icon: theme.chrome.launcherIcon ?? launcherGlyphFor(theme.chrome.launcher), size: glyph });
    $[24] = glyph;
  ...
  let t13;
  if ($[30] !== t11 || $[31] !== t12) {
    t13 = /* @__PURE__ */ jsx12("span", { style: t11, children: t12 });
    $[30] = t11;
    $[31] = t12;
    $[32] = t13;
  } else {
  ...
  if ($[33] !== handlers || $[34] !== launcherOpen || $[35] !== t10 || $[36] !== t13 || $[37] !== t5 || $[38] !== t6) {
    t14 = /* @__PURE__ */ jsx12("button", { type: "button", "aria-label": "Open launcher", "aria-expanded": launcherOpen, onClick: _temp33, ...handlers, onMouseEnter: t5, onMouseLeave: t6, style: t10, children: t13 });
    $[33] = handlers;
    $[34] = launcherOpen;
    $[35] = t10;
    $[36] = t13;
...
function LauncherGlyph(t0) {
  ...
  if (icon === "windows") {
    ...
    let t52;
    if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t22 = /* @__PURE__ */ jsx12("rect", { x: "1", y: "1", width: "6.6", height: "6.6" });
      t32 = /* @__PURE__ */ jsx12("rect", { x: "8.4", y: "1", width: "6.6", height: "6.6" });
      t42 = /* @__PURE__ */ jsx12("rect", { x: "1", y: "8.4", width: "6.6", height: "6.6" });
      t52 = /* @__PURE__ */ jsx12("rect", { x: "8.4", y: "8.4", width: "6.6", height: "6.6" });
      $[0] = t22;
      $[1] = t32;
      $[2] = t42;
      $[3] = t52;
    ...
    let t62;
    if ($[4] !== size) {
      t62 = /* @__PURE__ */ jsxs10("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: WINDOWS_LOGO_BLUE, "aria-hidden": true, children: [
        t22,
        t32,
        t42,
        t52
  ...
  if (icon === "grid") {
    ...
    let t32;
    if ($[7] !== size) {
      t32 = /* @__PURE__ */ jsx12("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": true, children: t22 });
      $[7] = size;
      $[8] = t32;
    } else {
      t32 = $[8];
  ...
  if (icon === "ubuntu") {
    ...
    let t52;
    if ($[9] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t22 = /* @__PURE__ */ jsx12("circle", { cx: "8", cy: "8", r: "5", fill: "none", stroke: "currentColor", strokeWidth: "1.3" });
      t32 = /* @__PURE__ */ jsx12("circle", { cx: "8", cy: "3", r: "1.75" });
      t42 = /* @__PURE__ */ jsx12("circle", { cx: "3.67", cy: "10.5", r: "1.75" });
      t52 = /* @__PURE__ */ jsx12("circle", { cx: "12.33", cy: "10.5", r: "1.75" });
      $[9] = t22;
      $[10] = t32;
      $[11] = t42;
      $[12] = t52;
    ...
    let t62;
    if ($[13] !== size) {
      t62 = /* @__PURE__ */ jsxs10("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": true, children: [
        t22,
        t32,
        t42,
        t52
  ...
  let t5;
  if ($[15] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t2 = /* @__PURE__ */ jsx12("rect", { x: "1", y: "1", width: "6", height: "6", rx: "1.5" });
    t3 = /* @__PURE__ */ jsx12("rect", { x: "9", y: "1", width: "6", height: "6", rx: "1.5" });
    t4 = /* @__PURE__ */ jsx12("rect", { x: "1", y: "9", width: "6", height: "6", rx: "1.5" });
    t5 = /* @__PURE__ */ jsx12("rect", { x: "9", y: "9", width: "6", height: "6", rx: "1.5" });
    $[15] = t2;
    $[16] = t3;
    $[17] = t4;
    $[18] = t5;
  ...
  let t6;
  if ($[19] !== size) {
    t6 = /* @__PURE__ */ jsxs10("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": true, children: [
      t2,
      t3,
      t4,
      t5
...
function _temp43(cy) {
  return [3, 8, 13].map((cx) => /* @__PURE__ */ jsx12("circle", { cx, cy, r: "1.5" }, `${cx}-${cy}`));
}
function TaskViewButton(t0) {
  ...
  if ($[14] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t7 = /* @__PURE__ */ jsx12("rect", { x: "4.5", y: "2.5", width: "11", height: "8", rx: "1.5", stroke: "currentColor", strokeWidth: "1.3" });
    $[14] = t7;
  } else {
    t7 = $[14];
  }
  ...
  if ($[15] !== theme.palette.surface) {
    t8 = /* @__PURE__ */ jsx12("rect", { x: "2.5", y: "6.5", width: "9", height: "8", rx: "1.5", fill: theme.palette.surface, stroke: "currentColor", strokeWidth: "1.3" });
  ...
  let t9;
  if ($[17] !== glyph || $[18] !== t8) {
    t9 = /* @__PURE__ */ jsxs10("svg", { width: glyph, height: glyph, viewBox: "0 0 18 18", fill: "none", "aria-hidden": true, children: [
      t7,
      t8
    ] });
    $[17] = glyph;
  ...
  let t10;
  if ($[20] !== t6 || $[21] !== t9) {
    t10 = /* @__PURE__ */ jsx12("span", { style: t6, children: t9 });
    $[20] = t6;
    $[21] = t9;
    $[22] = t10;
  } else {
  ...
  if ($[23] !== handlers || $[24] !== t10 || $[25] !== t3 || $[26] !== t5) {
    t11 = /* @__PURE__ */ jsx12("button", { type: "button", "aria-label": "Task view", onClick: _temp54, ...handlers, onMouseEnter: t3, onMouseLeave: _temp63, style: t5, children: t10 });
    $[23] = handlers;
    $[24] = t10;
    $[25] = t3;
    $[26] = t5;
...
function ShowDesktopButton(t0) {
  ...
  if ($[14] !== handleClick || $[15] !== t3 || $[16] !== t6) {
    t7 = /* @__PURE__ */ jsx12("button", { type: "button", "aria-label": "Show desktop", onClick: handleClick, onMouseEnter: t3, onMouseLeave: _temp73, style: t6 });
    $[14] = handleClick;
    $[15] = t3;
    $[16] = t6;
    $[17] = t7;
...
function TaskbarTray(t0) {
  ...
  const theme = useTheme();
  const items3 = useSyncExternalStore4(subscribeStatusItems, listStatusItems, listStatusItems);
  const {
    unreadCount
  } = useNotifications2();
  const [now, setNow] = useState8(null);
  let t2;
  let t3;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t2 = () => {
  ...
  if ($[20] !== theme.palette.accent || $[21] !== unreadCount) {
    t15 = unreadCount > 0 && /* @__PURE__ */ jsx12("span", { "aria-hidden": true, style: {
      position: "absolute",
      top: 4,
      right: 4,
      width: 6,
  ...
  let t17;
  if ($[24] !== time) {
    t17 = /* @__PURE__ */ jsx12("span", { style: t16, children: time });
    $[24] = time;
    $[25] = t17;
  } else {
    t17 = $[25];
  ...
  if ($[26] !== date || $[27] !== theme.palette.textSecondary || $[28] !== vertical) {
    t18 = !vertical && /* @__PURE__ */ jsx12("span", { style: {
      fontSize: 11,
      color: theme.palette.textSecondary
    }, children: date });
    $[26] = date;
  ...
  if ($[30] !== t14 || $[31] !== t15 || $[32] !== t17 || $[33] !== t18 || $[34] !== t8 || $[35] !== t9) {
    t19 = /* @__PURE__ */ jsxs10("button", { type: "button", onClick: _temp93, "aria-label": t8, onMouseEnter: t9, onMouseLeave: _temp03, style: t14, children: [
      t15,
      t17,
      t18
    ] });
  ...
  if ($[37] !== t19 || $[38] !== t6 || $[39] !== t7) {
    t20 = /* @__PURE__ */ jsxs10("div", { style: t6, children: [
      t7,
      t19
    ] });
    $[37] = t19;
...
function _temp83(item) {
  return /* @__PURE__ */ jsx12(TrayStatusItem, { item }, item.id);
}
function TrayStatusItem(t0) {
  ...
  if ($[8] !== item.badge || $[9] !== theme.palette.accent) {
    t7 = item.badge !== void 0 && item.badge !== "" && item.badge !== 0 && /* @__PURE__ */ jsx12("span", { "aria-hidden": true, style: {
      position: "absolute",
      top: -1,
      right: -1,
      minWidth: 12,
  ...
  if ($[11] !== item.icon || $[12] !== item.onClick || $[13] !== t1 || $[14] !== t2 || $[15] !== t3 || $[16] !== t6 || $[17] !== t7) {
    t8 = /* @__PURE__ */ jsxs10("button", { type: "button", onClick: item.onClick, disabled: t1, "aria-label": t2, onMouseEnter: t3, onMouseLeave: _temp13, style: t6, children: [
      item.icon,
      t7
    ] });
    $[11] = item.icon;
...
function DockTile(t0) {
  ...
  if ($[72] !== Art || $[73] !== Icon || $[74] !== app.name || $[75] !== artScale || $[76] !== bar || $[77] !== glyphScale || $[78] !== macosFullBleed || $[79] !== size) {
    t18 = macosFullBleed && Icon ? /* @__PURE__ */ jsx12(Icon, { size: Math.round(size * 0.92) }) : Art ? /* @__PURE__ */ jsx12(Art, { size: Math.round(size * artScale) }) : Icon ? /* @__PURE__ */ jsx12(Icon, { size: Math.round(size * glyphScale) }) : /* @__PURE__ */ jsx12("span", { style: {
      fontFamily: "inherit",
      fontWeight: 700,
  ...
  let t19;
  if ($[81] !== t17 || $[82] !== t18) {
    t19 = /* @__PURE__ */ jsx12("span", { style: t17, children: t18 });
    $[81] = t17;
    $[82] = t18;
    $[83] = t19;
  } else {
  ...
  if ($[84] !== app.name || $[85] !== labeledButton || $[86] !== theme.palette.textPrimary) {
    t20 = labeledButton ? /* @__PURE__ */ jsx12("span", { style: {
      minWidth: 0,
      fontSize: 12,
      fontFamily: "inherit",
      color: theme.palette.textPrimary,
  ...
  if ($[88] !== accent || $[89] !== bar || $[90] !== dur || $[91] !== isFocused || $[92] !== position || $[93] !== theme.palette.textPrimary || $[94] !== theme.palette.textSecondary || $[95] !== verticalTile || $[96] !== win) {
    t21 = win && (bar ? /* @__PURE__ */ jsx12("span", { "aria-hidden": true, style: {
      position: "absolute",
      borderRadius: 2,
  ...
  let t22;
  if ($[98] !== badgeCount) {
    t22 = badgeCount > 0 && /* @__PURE__ */ jsx12("span", { "aria-label": `${String(badgeCount)} unread notifications`, style: {
      position: "absolute",
      top: -4,
      right: -4,
      minWidth: 18,
  ...
  if ($[100] !== app.id || $[101] !== app.name || $[102] !== handleClick || $[103] !== handleContextMenu || $[104] !== t10 || $[105] !== t16 || $[106] !== t19 || $[107] !== t20 || $[108] !== t21 || $[109] !== t22 || $[110] !== t8 || $[111] !== t9) {
    t23 = /* @__PURE__ */ jsxs10("button", { ref: buttonRef, type: "button", onClick: handleClick, onContextMenu: handleContextMenu, "aria-label": app.name, "data-dock-app-id": app.id, ...t8, onMouseEnter: t9, onMouseLeave: t10, style: t16, children: [
      t19,
      t20,
      t21,
      t22
...
import { useWindowManager as useWindowManager4 } from "@react-ui-os/core";

// src/Window.tsx
import { c as _c17 } from "react/compiler-runtime";
import { useEffect as useEffect11, useLayoutEffect as useLayoutEffect4, useRef as useRef7, useState as useState10 } from "react";
import { useWindowManager as useWindowManager3 } from "@react-ui-os/core";
...
function SnapPreview() {
  const $ = _c15(8);
  const theme = useTheme();
  const state = useSyncExternalStore5(subscribeSnapPreview, getSnapPreview, _temp14);
  if (!state) {
    return null;
  }
  const {
  ...
  if ($[0] !== rect.h || $[1] !== rect.w || $[2] !== rect.x || $[3] !== rect.y || $[4] !== t0 || $[5] !== t1 || $[6] !== theme.shape.windowRadius) {
    t2 = /* @__PURE__ */ jsx13("div", { "aria-hidden": true, style: {
      position: "fixed",
      left: rect.x,
      top: rect.y,
      width: rect.w,
...
import { useEffect as useEffect10, useState as useState9, useSyncExternalStore as useSyncExternalStore6 } from "react";
...
function HudOverlay() {
  ...
  const theme = useTheme();
  const reducedMotion = useReducedMotion();
  const active4 = useSyncExternalStore6(subscribeHud, getHud, _temp15);
  const [phase, setPhase] = useState9("enter");
  let t0;
  if ($[0] !== active4) {
    t0 = () => {
      if (active4) {
  ...
  useEffect10(t0, t2);
  const [lastShown, setLastShown] = useState9(null);
  let t3;
  let t4;
  if ($[5] !== active4) {
    t3 = () => {
  ...
  if ($[18] !== accent || $[19] !== lastShown.icon) {
    t11 = lastShown.icon && /* @__PURE__ */ jsx14("div", { "aria-hidden": true, style: {
      width: 48,
      height: 48,
      margin: "0 auto 8px",
      display: "grid",
  ...
  if ($[22] !== lastShown.title) {
    t13 = /* @__PURE__ */ jsx14("div", { style: t12, children: lastShown.title });
    $[22] = lastShown.title;
    $[23] = t13;
  } else {
    t13 = $[23];
  ...
  if ($[24] !== lastShown.sublabel || $[25] !== theme.palette.textSecondary) {
    t14 = lastShown.sublabel && /* @__PURE__ */ jsx14("div", { style: {
      marginTop: 2,
      fontSize: 11,
      color: theme.palette.textSecondary
  ...
  if ($[27] !== accent || $[28] !== hasProgress || $[29] !== lastShown.progress || $[30] !== theme.palette.border) {
    t15 = hasProgress && /* @__PURE__ */ jsx14("div", { "aria-hidden": true, style: {
      marginTop: 12,
      height: 4,
      borderRadius: 2,
      background: theme.palette.border,
      overflow: "hidden"
    }, children: /* @__PURE__ */ jsx14("div", { style: {
      height: "100%",
  ...
  if ($[32] !== surface || $[33] !== t11 || $[34] !== t13 || $[35] !== t14 || $[36] !== t15) {
    t16 = /* @__PURE__ */ jsxs11("div", { role: "status", "aria-live": "polite", style: surface, children: [
      t11,
      t13,
      t14,
      t15
...
function Window({
  ...
  const elRef = useRef7(null);
  const dragRef = useRef7(null);
  const resizeRef = useRef7(null);
  const [phase, setPhase] = useState10("opening");
  const [gesturing, setGesturing] = useState10(false);
  const prevStateRef = useRef7(win.state);
  const reducedMotion = useReducedMotion();
  const {
  ...
  return /* @__PURE__ */ jsxs12("div", { ref: elRef, role: "region", "aria-label": `${title} window`, "data-rui-window": win.id, onPointerDown: () => {
    ...
    /* @__PURE__ */ jsx15(TitleBar, { title, focused, accent, height: titleBarHeight, maximized, onClose: handleClose, onMinimize: handleMinimize, onMaximize: handleMaximize, onPointerDown: startDrag, onPointerMove: moveDrag, onPointerUp: endDrag, onPointerCancel: endDrag, onDoubleClick: handleMaximize, onContextMenu: handleTitleContextMenu }),
    /* @__PURE__ */ jsx15("div", { style: {
      flex: 1,
      minHeight: 0,
      overflow: "auto",
      padding: 16
    }, children: app ? /* @__PURE__ */ jsx15(app.content, { appId: app.id, focused }) : systemDef ? /* @__PURE__ */ jsx15(systemDef.content, { focused, args: systemArgs }) : null }),
    !maximized && /* @__PURE__ */ jsx15(ResizeHandles, { onStart: startResize, onMove: moveResize, onEnd: endResize })
  ] });
}
...
function ResizeHandles(t0) {
  ...
  if ($[0] !== onEnd || $[1] !== onMove || $[2] !== onStart) {
    t1 = (dir, style, cursor) => /* @__PURE__ */ jsx15("div", { onPointerDown: (e) => {
      onStart(dir, e);
  ...
  let t2;
  if ($[4] !== edge) {
    t2 = /* @__PURE__ */ jsxs12(Fragment4, { children: [
      edge("n", {
        top: 0,
        left: CORNER_SIZE,
        right: CORNER_SIZE,
...
function TitleBar(t0) {
  ...
  let t7;
  if ($[6] !== t6) {
    t7 = /* @__PURE__ */ jsx15("span", { "aria-hidden": true, style: {
      position: "absolute",
      top: 0,
      left: 0,
      right: 0,
  ...
  if ($[8] !== controls || $[9] !== focused || $[10] !== maximized || $[11] !== onClose || $[12] !== onMaximize || $[13] !== onMinimize || $[14] !== title || $[15] !== trafficLights) {
    t8 = trafficLights ? /* @__PURE__ */ jsxs12(Fragment4, { children: [
      /* @__PURE__ */ jsx15(TrafficLights, { focused, onClose, onMinimize, onMaximize }),
      /* @__PURE__ */ jsx15(TitleLabel, { title, focused, centered: true }),
      /* @__PURE__ */ jsx15("span", { style: {
        width: 60
      }, "aria-hidden": true })
    ] }) : /* @__PURE__ */ jsxs12(Fragment4, { children: [
      /* @__PURE__ */ jsx15(TitleLabel, { title, focused }),
      controls === "windows" ? /* @__PURE__ */ jsx15(WindowsControls, { focused, maximized, onClose, onMinimize, onMaximize }) : controls === "gnome" ? /* @__PURE__ */ jsx15(GnomeControls, { focused, maximized, onClose, onMinimize, onMaximize }) : /* @__PURE__ */ jsx15(MinimalControls, { focused, onClose })
    ] });
    $[8] = controls;
    $[9] = focused;
    $[10] = maximized;
  ...
  if ($[17] !== onContextMenu || $[18] !== onDoubleClick || $[19] !== onPointerCancel || $[20] !== onPointerDown || $[21] !== onPointerMove || $[22] !== onPointerUp || $[23] !== t5 || $[24] !== t7 || $[25] !== t8) {
    t9 = /* @__PURE__ */ jsxs12("div", { onPointerDown, onPointerMove, onPointerUp, onPointerCancel, onDoubleClick, onContextMenu, style: t5, children: [
      t7,
      t8
    ] });
    $[17] = onContextMenu;
...
function TitleLabel(t0) {
  ...
  let t6;
  if ($[6] !== t5 || $[7] !== title) {
    t6 = /* @__PURE__ */ jsx15("span", { style: t5, children: title });
    $[6] = t5;
    $[7] = title;
    $[8] = t6;
  } else {
...
function WindowsControls(t0) {
  ...
  if ($[1] !== focused || $[2] !== onMinimize) {
    t2 = /* @__PURE__ */ jsx15(CaptionButton, { glyph: "minimize", focused, onClick: onMinimize, ariaLabel: "Minimize" });
    $[1] = focused;
    $[2] = onMinimize;
    $[3] = t2;
  } else {
  ...
  if ($[4] !== focused || $[5] !== onMaximize || $[6] !== t3 || $[7] !== t4) {
    t5 = /* @__PURE__ */ jsx15(CaptionButton, { glyph: t3, focused, onClick: onMaximize, ariaLabel: t4 });
    $[4] = focused;
    $[5] = onMaximize;
    $[6] = t3;
    $[7] = t4;
  ...
  if ($[9] !== focused || $[10] !== onClose) {
    t6 = /* @__PURE__ */ jsx15(CaptionButton, { glyph: "close", focused, onClick: onClose, ariaLabel: "Close", danger: true });
    $[9] = focused;
    $[10] = onClose;
    $[11] = t6;
  } else {
  ...
  if ($[12] !== t2 || $[13] !== t5 || $[14] !== t6) {
    t7 = /* @__PURE__ */ jsxs12("div", { onPointerDown: _temp16, style: t1, children: [
      t2,
      t5,
      t6
    ] });
...
function CaptionButton(t0) {
  ...
  let t6;
  if ($[9] !== glyph) {
    t6 = /* @__PURE__ */ jsx15(CaptionGlyph, { glyph });
    $[9] = glyph;
    $[10] = t6;
  } else {
    t6 = $[10];
  ...
  if ($[11] !== ariaLabel || $[12] !== onClick || $[13] !== t3 || $[14] !== t4 || $[15] !== t5 || $[16] !== t6) {
    t7 = /* @__PURE__ */ jsx15("button", { type: "button", onClick, "aria-label": ariaLabel, style: t3, onMouseEnter: t4, onMouseLeave: t5, children: t6 });
    $[11] = ariaLabel;
    $[12] = onClick;
    $[13] = t3;
    $[14] = t4;
...
function GnomeControls(t0) {
  ...
  let t2;
  if ($[1] !== focused || $[2] !== onMinimize) {
    t2 = /* @__PURE__ */ jsx15(GnomeControl, { glyph: "minimize", focused, onClick: onMinimize, ariaLabel: "Minimize" });
    $[1] = focused;
    $[2] = onMinimize;
    $[3] = t2;
  } else {
  ...
  let t5;
  if ($[4] !== focused || $[5] !== onMaximize || $[6] !== t3 || $[7] !== t4) {
    t5 = /* @__PURE__ */ jsx15(GnomeControl, { glyph: t3, focused, onClick: onMaximize, ariaLabel: t4 });
    $[4] = focused;
    $[5] = onMaximize;
    $[6] = t3;
    $[7] = t4;
  ...
  let t6;
  if ($[9] !== focused || $[10] !== onClose) {
    t6 = /* @__PURE__ */ jsx15(GnomeControl, { glyph: "close", focused, onClick: onClose, ariaLabel: "Close" });
    $[9] = focused;
    $[10] = onClose;
    $[11] = t6;
  } else {
  ...
  let t7;
  if ($[12] !== t2 || $[13] !== t5 || $[14] !== t6) {
    t7 = /* @__PURE__ */ jsxs12("div", { onPointerDown: _temp25, style: t1, children: [
      t2,
      t5,
      t6
    ] });
...
function GnomeControl(t0) {
  ...
  let t7;
  if ($[8] !== glyph || $[9] !== t6) {
    t7 = /* @__PURE__ */ jsx15(CaptionGlyph, { glyph, size: t6 });
    $[8] = glyph;
    $[9] = t6;
    $[10] = t7;
  } else {
  ...
  if ($[11] !== ariaLabel || $[12] !== onClick || $[13] !== t3 || $[14] !== t4 || $[15] !== t5 || $[16] !== t7) {
    t8 = /* @__PURE__ */ jsx15("button", { type: "button", onClick, "aria-label": ariaLabel, style: t3, onMouseEnter: t4, onMouseLeave: t5, children: t7 });
    $[11] = ariaLabel;
    $[12] = onClick;
    $[13] = t3;
    $[14] = t4;
...
function MinimalControls(t0) {
  ...
  let t5;
  if ($[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t5 = /* @__PURE__ */ jsx15(CaptionGlyph, { glyph: "close" });
    $[6] = t5;
  } else {
    t5 = $[6];
  }
  ...
  if ($[7] !== onClose || $[8] !== t3 || $[9] !== t4) {
    t6 = /* @__PURE__ */ jsx15("button", { type: "button", onPointerDown: _temp34, onClick: onClose, "aria-label": "Close", style: t3, onMouseEnter: t4, onMouseLeave: _temp44, children: t5 });
    $[7] = onClose;
    $[8] = t3;
    $[9] = t4;
    $[10] = t6;
...
function CaptionGlyph(t0) {
  ...
  switch (glyph) {
    case "minimize": {
      let t3;
      if ($[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
        t3 = /* @__PURE__ */ jsx15("line", { x1: "0", y1: "5", x2: "10", y2: "5" });
        $[1] = t3;
      } else {
        t3 = $[1];
      }
      let t4;
      if ($[2] !== size) {
        t4 = /* @__PURE__ */ jsx15("svg", { width: size, height: size, viewBox: "0 0 10 10", "aria-hidden": true, ...stroke, children: t3 });
        $[2] = size;
        $[3] = t4;
      } else {
        t4 = $[3];
    ...
    case "maximize": {
      let t3;
      if ($[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
        t3 = /* @__PURE__ */ jsx15("rect", { x: "0.5", y: "0.5", width: "9", height: "9" });
        $[4] = t3;
      } else {
        t3 = $[4];
      }
    ...
    case "restore": {
      ...
      let t4;
      if ($[7] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
        t3 = /* @__PURE__ */ jsx15("rect", { x: "0.5", y: "3.5", width: "7", height: "7" });
        t4 = /* @__PURE__ */ jsx15("path", { d: "M3.5 3.5 V0.5 H10.5 V7.5 H7.5" });
        $[7] = t3;
        $[8] = t4;
      } else {
        t3 = $[7];
      ...
      let t5;
      if ($[9] !== size) {
        t5 = /* @__PURE__ */ jsxs12("svg", { width: size, height: size, viewBox: "0 0 11 11", "aria-hidden": true, ...stroke, children: [
          t3,
          t4
        ] });
        $[9] = size;
    ...
    case "close": {
      ...
      if ($[11] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
        t3 = /* @__PURE__ */ jsx15("line", { x1: "0.5", y1: "0.5", x2: "9.5", y2: "9.5" });
        t4 = /* @__PURE__ */ jsx15("line", { x1: "9.5", y1: "0.5", x2: "0.5", y2: "9.5" });
        $[11] = t3;
        $[12] = t4;
      } else {
        t3 = $[11];
      ...
      let t5;
      if ($[13] !== size) {
        t5 = /* @__PURE__ */ jsxs12("svg", { width: size, height: size, viewBox: "0 0 10 10", "aria-hidden": true, ...stroke, children: [
          t3,
          t4
        ] });
        $[13] = size;
...
function TrafficLights(t0) {
  ...
  if ($[3] !== focused || $[4] !== hovered || $[5] !== onClose) {
    t4 = /* @__PURE__ */ jsx15(TrafficLight, { kind: "close", color: "#ff5f57", onClick: onClose, focused, revealed: hovered });
    $[3] = focused;
    $[4] = hovered;
    $[5] = onClose;
    $[6] = t4;
  ...
  if ($[7] !== focused || $[8] !== hovered || $[9] !== onMinimize) {
    t5 = /* @__PURE__ */ jsx15(TrafficLight, { kind: "minimize", color: "#febc2e", onClick: onMinimize, focused, revealed: hovered });
    $[7] = focused;
    $[8] = hovered;
    $[9] = onMinimize;
    $[10] = t5;
  ...
  if ($[11] !== focused || $[12] !== hovered || $[13] !== onMaximize) {
    t6 = /* @__PURE__ */ jsx15(TrafficLight, { kind: "zoom", color: "#28c840", onClick: onMaximize, focused, revealed: hovered });
    $[11] = focused;
    $[12] = hovered;
    $[13] = onMaximize;
    $[14] = t6;
  ...
  if ($[15] !== t4 || $[16] !== t5 || $[17] !== t6) {
    t7 = /* @__PURE__ */ jsxs12("div", { onPointerDown: _temp55, onMouseEnter: t1, onMouseLeave: t2, style: t3, children: [
      t4,
      t5,
      t6
    ] });
...
function TrafficLightGlyph(t0) {
  ...
  if (kind === "close") {
    let t12;
    if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t12 = /* @__PURE__ */ jsx15("svg", { width: "7", height: "7", viewBox: "0 0 7 7", "aria-hidden": true, children: /* @__PURE__ */ jsx15("path", { d: "M1.4 1.4 L5.6 5.6 M5.6 1.4 L1.4 5.6", stroke: "rgba(0,0,0,0.55)", strokeWidth: "1.1", strokeLinecap: "round" }) });
      $[0] = t12;
    } else {
      t12 = $[0];
    }
  ...
  if (kind === "minimize") {
    let t12;
    if ($[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t12 = /* @__PURE__ */ jsx15("svg", { width: "8", height: "7", viewBox: "0 0 8 7", "aria-hidden": true, children: /* @__PURE__ */ jsx15("path", { d: "M1.2 3.5 H6.8", stroke: "rgba(0,0,0,0.55)", strokeWidth: "1.1", strokeLinecap: "round" }) });
      $[1] = t12;
    } else {
      t12 = $[1];
    }
  ...
  let t1;
  if ($[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsxs12("svg", { width: "8", height: "8", viewBox: "0 0 8 8", "aria-hidden": true, fill: "rgba(0,0,0,0.55)", children: [
      /* @__PURE__ */ jsx15("path", { d: "M1.2 1.2 H5 L1.2 5 Z" }),
      /* @__PURE__ */ jsx15("path", { d: "M6.8 6.8 H3 L6.8 3 Z" })
    ] });
    $[2] = t1;
  } else {
    t1 = $[2];
...
function TrafficLight(t0) {
  ...
  let t6;
  if ($[4] !== kind) {
    t6 = /* @__PURE__ */ jsx15(TrafficLightGlyph, { kind });
    $[4] = kind;
    $[5] = t6;
  } else {
    t6 = $[5];
  ...
  let t7;
  if ($[6] !== t5 || $[7] !== t6) {
    t7 = /* @__PURE__ */ jsx15("span", { "aria-hidden": true, style: t5, children: t6 });
    $[6] = t5;
    $[7] = t6;
    $[8] = t7;
  } else {
  ...
  if ($[9] !== onClick || $[10] !== t2 || $[11] !== t3 || $[12] !== t7) {
    t8 = /* @__PURE__ */ jsx15("button", { type: "button", onClick, style: t2, "aria-label": t3, children: t7 });
    $[9] = onClick;
    $[10] = t2;
    $[11] = t3;
    $[12] = t7;
...
function WindowLayer() {
  ...
  if ($[0] !== active4 || $[1] !== windows) {
    let t12;
    if ($[3] !== active4) {
      t12 = (win) => /* @__PURE__ */ jsx16(Window, { win, hidden: win.workspaceId !== active4 }, win.id);
      $[3] = active4;
      $[4] = t12;
    } else {
      t12 = $[4];
  ...
  let t1;
  if ($[5] !== t0) {
    t1 = /* @__PURE__ */ jsx16(Fragment5, { children: t0 });
    $[5] = t0;
    $[6] = t1;
  } else {
    t1 = $[6];
...
import { useWindowManager as useWindowManager5, windowIdOf as windowIdOf2 } from "@react-ui-os/core";
...
import { useEffect as useEffect15, useRef as useRef9, useState as useState13, useSyncExternalStore as useSyncExternalStore8 } from "react";
import { notify as notify2, useWindowManager as useWindowManager7 } from "@react-ui-os/core";
...
function SpacesBar(t0) {
  ...
  if ($[1] !== activeId || $[2] !== onSwitch || $[3] !== theme.motion.dockHoverDurationMs || $[4] !== theme.palette.background || $[5] !== theme.palette.border || $[6] !== theme.palette.textPrimary || $[7] !== theme.palette.textSecondary || $[8] !== theme.shape.small || $[9] !== wallpaperSrc || $[10] !== windows || $[11] !== workspaces) {
    ...
    if ($[13] !== activeId || $[14] !== onSwitch || $[15] !== theme.motion.dockHoverDurationMs || $[16] !== theme.palette.background || $[17] !== theme.palette.border || $[18] !== theme.palette.textPrimary || $[19] !== theme.palette.textSecondary || $[20] !== theme.shape.small || $[21] !== wallpaperSrc || $[22] !== windows) {
      t32 = (id, i) => {
        ...
        return /* @__PURE__ */ jsxs13("button", { type: "button", role: "tab", "data-mc-space": true, "aria-selected": active4, "aria-label": `Desktop ${String(i + 1)}`, onClick: () => {
          onSwitch(id);
          ...
          /* @__PURE__ */ jsx17("span", { "aria-hidden": true, style: {
            position: "relative",
            display: "block",
            width: 124,
            height: 74,
            ...
            boxShadow: "0 6px 16px -8px rgba(0,0,0,0.5)",
            overflow: "hidden"
          }, children: spaceWindows.map((w_0) => /* @__PURE__ */ jsx17("span", { style: {
            position: "absolute",
  ...
  if ($[28] !== t6 || $[29] !== theme.palette.textSecondary || $[30] !== theme.shape.small) {
    t7 = /* @__PURE__ */ jsx17("span", { "aria-hidden": true, style: {
      display: "grid",
      placeItems: "center",
      width: 124,
      height: 74,
  ...
  if ($[34] !== t3 || $[35] !== t5 || $[36] !== t7 || $[37] !== t8) {
    t9 = /* @__PURE__ */ jsxs13("button", { type: "button", "data-mc-space": true, "aria-label": "Add a space", onClick: t3, onPointerEnter: _temp26, onPointerLeave: _temp35, style: t5, children: [
      t7,
      t8
    ] });
    $[34] = t3;
  ...
  let t10;
  if ($[39] !== t2 || $[40] !== t9) {
    t10 = /* @__PURE__ */ jsxs13("div", { role: "tablist", "aria-label": "Spaces", style: t1, children: [
      t2,
      t9
    ] });
    $[39] = t2;
...
function useSurfaceTransition(open2, t0) {
  ...
  const [mounted, setMounted] = useState11(open2);
  const [phase, setPhase] = useState11(open2 ? "open" : "closing");
  let t1;
  let t2;
...
import { useCallback as useCallback3, useEffect as useEffect14, useMemo as useMemo2, useRef as useRef8, useState as useState12, useSyncExternalStore as useSyncExternalStore7 } from "react";
import { useWindowManager as useWindowManager6 } from "@react-ui-os/core";
...
function useLauncher() {
  ...
  const [open2, setOpen] = useState12(false);
  ...
  useEffect14(t6, t7);
  const sourcesVersion = useSyncExternalStore7(subscribeSpotlightSources, _temp27, _temp36);
  let t8;
  if ($[11] !== apps || $[12] !== query) {
    bb0: {
  ...
  switch (theme.chrome.launcher) {
    case "grid": {
      ...
      if ($[3] !== launcher || $[4] !== surfaceStyle) {
        t1 = /* @__PURE__ */ jsx18(GridView, { launcher, surfaceStyle });
        $[3] = launcher;
        $[4] = surfaceStyle;
        $[5] = t1;
      } else {
    ...
    case "menu": {
      ...
      if ($[6] !== launcher || $[7] !== phase) {
        t1 = /* @__PURE__ */ jsx18(MenuView, { launcher, phase });
        $[6] = launcher;
        $[7] = phase;
        $[8] = t1;
      } else {
    ...
    default: {
      ...
      if ($[9] !== launcher || $[10] !== surfaceStyle) {
        t1 = /* @__PURE__ */ jsx18(SpotlightView, { launcher, surfaceStyle });
        $[9] = launcher;
        $[10] = surfaceStyle;
        $[11] = t1;
      } else {
...
function SpotlightView(t0) {
  ...
  if ($[29] !== query || $[30] !== t13 || $[31] !== t14 || $[32] !== t15 || $[33] !== t16) {
    t17 = /* @__PURE__ */ jsx18("input", { ref: inputRef, role: "combobox", "aria-label": "Search apps and commands", "aria-autocomplete": "list", "aria-controls": SPOTLIGHT_LISTBOX_ID, "aria-expanded": t13, "aria-activedescendant": t14, value: query, onChange: t15, placeholder: "Search apps...", style: t16 });
    $[29] = query;
    $[30] = t13;
    $[31] = t14;
    $[32] = t15;
  ...
  let t18;
  if ($[35] !== t12 || $[36] !== t17) {
    t18 = /* @__PURE__ */ jsx18("div", { style: t12, children: t17 });
    $[35] = t12;
    $[36] = t17;
    $[37] = t18;
  } else {
  ...
  if ($[39] !== activate2 || $[40] !== query || $[41] !== results || $[42] !== selectedIndex || $[43] !== setSelectedIndex) {
    t20 = results.length === 0 ? /* @__PURE__ */ jsx18(EmptyState, { query }) : results.map((result, i) => /* @__PURE__ */ jsx18(ResultRow, { result, index: i, selected: i === selectedIndex, onHover: () => {
      setSelectedIndex(i);
    }, onActivate: () => {
      activate2(result);
    } }, result.key));
  ...
  let t21;
  if ($[45] !== t20) {
    t21 = /* @__PURE__ */ jsx18("div", { ref: listRef, id: SPOTLIGHT_LISTBOX_ID, role: "listbox", "aria-label": "Spotlight results", style: t19, children: t20 });
    $[45] = t20;
    $[46] = t21;
  } else {
    t21 = $[46];
  ...
  if ($[50] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t24 = /* @__PURE__ */ jsx18(HintChip, { keys: "\u2191\u2193", label: "Navigate" });
    t25 = /* @__PURE__ */ jsx18(HintChip, { keys: "\u21B5", label: "Open" });
    t26 = /* @__PURE__ */ jsx18(HintChip, { keys: "Esc", label: "Close" });
    $[50] = t24;
    $[51] = t25;
    $[52] = t26;
  } else {
  ...
  let t27;
  if ($[53] !== t23) {
    t27 = /* @__PURE__ */ jsxs14("div", { style: t23, children: [
      t24,
      t25,
      t26
    ] });
  ...
  if ($[55] !== handlePaletteKey || $[56] !== t10 || $[57] !== t18 || $[58] !== t21 || $[59] !== t27) {
    t28 = /* @__PURE__ */ jsxs14("div", { role: "dialog", "aria-modal": "true", "aria-label": "Spotlight", onKeyDown: handlePaletteKey, style: t10, children: [
      t18,
      t21,
      t27
    ] });
  ...
  if ($[61] !== handleBackdropClick || $[62] !== t28 || $[63] !== t7) {
    t29 = /* @__PURE__ */ jsx18("div", { role: "presentation", onClick: handleBackdropClick, style: t7, children: t28 });
...
function GridView(t0) {
  ...
  if ($[21] !== query || $[22] !== t10 || $[23] !== t6 || $[24] !== t7 || $[25] !== t8) {
    t11 = /* @__PURE__ */ jsx18("input", { ref: inputRef, role: "combobox", "aria-label": "Search applications", "aria-autocomplete": "list", "aria-controls": GRID_LISTBOX_ID, "aria-expanded": t6, "aria-activedescendant": t7, value: query, onChange: t8, placeholder: "Type to search", style: t10 });
    $[21] = query;
    $[22] = t10;
    $[23] = t6;
    $[24] = t7;
  ...
  if ($[30] !== addWorkspace || $[31] !== state.activeWorkspaceId || $[32] !== state.workspaces || $[33] !== t12 || $[34] !== theme || $[35] !== windows) {
    t13 = /* @__PURE__ */ jsx18(SpacesBar, { workspaces: state.workspaces, activeId: state.activeWorkspaceId, onSwitch: t12, onAdd: addWorkspace, windows, wallpaperSrc: theme.wallpaper.src, theme });
    $[30] = addWorkspace;
  ...
  if ($[38] !== activate2 || $[39] !== query || $[40] !== results || $[41] !== selectedIndex || $[42] !== setSelectedIndex || $[43] !== theme.palette.textSecondary) {
    t15 = results.length === 0 ? /* @__PURE__ */ jsx18("div", { style: {
      gridColumn: "1 / -1",
      textAlign: "center",
      color: theme.palette.textSecondary,
      fontSize: 14,
      padding: "24px 0"
    }, children: query.trim().length > 0 ? `No matches for "${query.trim()}".` : "No applications." }) : results.map((result, i) => /* @__PURE__ */ jsx18(LauncherTile, { result, index: i, selected: i === selectedIndex, onHover: () => {
      setSelectedIndex(i);
    }, onActivate: () => {
      activate2(result);
    } }, result.key));
  ...
  let t16;
  if ($[45] !== t15) {
    t16 = /* @__PURE__ */ jsx18("div", { id: GRID_LISTBOX_ID, role: "listbox", "aria-label": "Applications", style: t14, children: t15 });
    $[45] = t15;
    $[46] = t16;
  } else {
    t16 = $[46];
  ...
  if ($[47] !== onKey || $[48] !== t11 || $[49] !== t13 || $[50] !== t16 || $[51] !== t4 || $[52] !== t5) {
    t17 = /* @__PURE__ */ jsxs14("div", { role: "presentation", onClick: t4, onKeyDown: onKey, style: t5, children: [
      t11,
      t13,
      t16
    ] });
...
function LauncherTile(t0) {
  ...
  if ($[25] !== Art || $[26] !== Icon || $[27] !== bare || $[28] !== externalIcon || $[29] !== result.name || $[30] !== tile) {
    t16 = Art ? /* @__PURE__ */ jsx18(Art, { size: Math.round(tile * (bare ? 0.8 : 0.7)) }) : Icon ? /* @__PURE__ */ jsx18(Icon, { size: Math.round(tile * (bare ? 0.8 : 0.46)) }) : externalIcon ? externalIcon : /* @__PURE__ */ jsx18("span", { style: {
      fontWeight: 700,
  ...
  let t17;
  if ($[32] !== t15 || $[33] !== t16) {
    t17 = /* @__PURE__ */ jsx18("div", { style: t15, children: t16 });
    $[32] = t15;
    $[33] = t16;
    $[34] = t17;
  } else {
  ...
  if ($[37] !== result.name || $[38] !== t18) {
    t19 = /* @__PURE__ */ jsx18("span", { style: t18, children: result.name });
    $[37] = result.name;
    $[38] = t18;
    $[39] = t19;
  } else {
  ...
  if ($[40] !== onActivate || $[41] !== t10 || $[42] !== t13 || $[43] !== t17 || $[44] !== t19 || $[45] !== t6 || $[46] !== t7 || $[47] !== t8 || $[48] !== t9) {
    t20 = /* @__PURE__ */ jsxs14("div", { id: t6, role: t7, "aria-selected": t8, onMouseEnter: t9, onMouseLeave: t10, onClick: onActivate, style: t13, children: [
      t17,
      t19
    ] });
    $[40] = onActivate;
...
function MenuView({
  ...
  const [showAllPins, setShowAllPins] = useState13(() => storage.get(PINS_EXPANDED_KEY) ?? false);
  ...
  useSyncExternalStore8(subscribeRecentsSources, countRecentsSources, () => 0);
  const recentRows = [
    ...recentApps.map((r_0) => ({
      key: `rec:${r_0.key}`,
      result: r_0,
  ...
  const listbox = /* @__PURE__ */ jsx18("div", { id: MENU_LISTBOX_ID, role: "listbox", "aria-label": searching ? "Results" : "Pinned", style: {
    display: "grid",
    gridTemplateColumns: `repeat(${String(cols)}, 1fr)`,
    gap: 4,
    justifyItems: "center",
    alignContent: "start"
  }, children: results.length === 0 ? /* @__PURE__ */ jsx18("div", { style: {
    gridColumn: "1 / -1",
    textAlign: "center",
    color: theme.palette.textSecondary,
    fontSize: 13,
    padding: "20px 0"
  }, children: searching ? `No matches for "${query.trim()}".` : "No apps." }) : results.slice(0, gridCount).map((result, i) => /* @__PURE__ */ jsx18(LauncherTile, { result, index: i, size: 40, plain: true, optionId: menuOptionId, selected: i === selectedIndex, onHover: () => {
    setSelectedIndex(i);
  }, onActivate: () => {
    activate2(result);
  } }, result.key)) });
  ...
  return /* @__PURE__ */ jsxs14(Fragment6, { children: [
    /* @__PURE__ */ jsx18("div", { role: "presentation", onClick: close, style: {
      position: "fixed",
      inset: 0,
      zIndex: 1399
    } }),
    /* @__PURE__ */ jsxs14("div", { role: "dialog", "aria-label": "Start", onKeyDown: onKey, style: {
      position: "fixed",
      ...anchor,
      width,
      height,
      ...
      /* @__PURE__ */ jsxs14("div", { style: {
        ...
        /* @__PURE__ */ jsxs14("svg", { width: 16, height: 16, viewBox: "0 0 16 16", fill: "none", "aria-hidden": true, style: {
          position: "absolute",
          left: 32,
          top: "50%",
          transform: "translateY(-50%)",
          ...
          /* @__PURE__ */ jsx18("circle", { cx: "7", cy: "7", r: "4.5", stroke: "currentColor", strokeWidth: "1.4" }),
          /* @__PURE__ */ jsx18("line", { x1: "10.4", y1: "10.4", x2: "14", y2: "14", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round" })
        ] }),
        /* @__PURE__ */ jsx18("input", { ref: inputRef, role: "combobox", "aria-label": "Search for apps", "aria-autocomplete": "list", "aria-controls": MENU_LISTBOX_ID, "aria-expanded": results.length > 0, "aria-activedescendant": results.length > 0 ? menuOptionId(selectedIndex) : void 0, value: query, onChange: (e_0) => {
      ...
      /* @__PURE__ */ jsxs14("div", { style: {
        ...
        searching ? /* @__PURE__ */ jsxs14(Fragment6, { children: [
          /* @__PURE__ */ jsx18(MenuSectionHeader, { label: "Results" }),
          listbox
        ] }) : pinnedOn ? /* @__PURE__ */ jsxs14(Fragment6, { children: [
          /* @__PURE__ */ jsx18(MenuSectionHeader, { label: "Pinned", action: results.length > defaultPins ? showAllPins ? {
            label: "Show less",
            onClick: () => {
              togglePins(false);
            },
        ...
        !searching && recentRows.length > 0 ? /* @__PURE__ */ jsxs14(Fragment6, { children: [
          /* @__PURE__ */ jsx18("div", { style: {
            height: 6
          } }),
          /* @__PURE__ */ jsx18(MenuSectionHeader, { label: "Recent" }),
          /* @__PURE__ */ jsx18("div", { style: {
            display: "grid",
            ...
            result: result_0,
            subtitle
          }) => /* @__PURE__ */ jsx18(MenuRow, { result: result_0, subtitle, onActivate: () => {
            activate2(result_0);
          } }, key)) })
        ] }) : null,
        !searching && allAppsOn && allSorted.length > 0 ? /* @__PURE__ */ jsx18(MenuAllSection, { items: allSorted, onActivate: (result_1) => {
          activate2(result_1);
        } }) : null
      ] }),
      /* @__PURE__ */ jsxs14("div", { style: {
        ...
        profileOn ? /* @__PURE__ */ jsxs14(MenuFooterButton, { "aria-label": "Account", onClick: openSettings, children: [
          /* @__PURE__ */ jsx18("span", { "aria-hidden": true, style: {
            width: 28,
            height: 28,
            borderRadius: "50%",
            background: theme.palette.accent,
            ...
            justifyContent: "center",
            flexShrink: 0
          }, children: /* @__PURE__ */ jsxs14("svg", { width: 16, height: 16, viewBox: "0 0 16 16", fill: "currentColor", children: [
            /* @__PURE__ */ jsx18("circle", { cx: "8", cy: "5", r: "3" }),
            /* @__PURE__ */ jsx18("path", { d: "M2.5 14a5.5 5.5 0 0 1 11 0z" })
          ] }) }),
        ...
        /* @__PURE__ */ jsx18(PowerButton, { onAction: close })
      ] })
    ] })
  ] });
}
...
function ResultMiniIcon(t0) {
  ...
  if (result.kind === "external" && result.icon) {
    let t22;
    if ($[11] !== result.icon) {
      t22 = /* @__PURE__ */ jsx18(Fragment6, { children: result.icon });
      $[11] = result.icon;
      $[12] = t22;
    } else {
      t22 = $[12];
  ...
  let t5;
  if ($[19] !== t3 || $[20] !== t4) {
    t5 = /* @__PURE__ */ jsx18("span", { style: t3, children: t4 });
    $[19] = t3;
    $[20] = t4;
    $[21] = t5;
  } else {
...
function MenuAllSection(t0) {
  ...
  const [view, setView] = useState13(t1);
  const [viewMenuOpen, setViewMenuOpen] = useState13(false);
  const [jumpOpen, setJumpOpen] = useState13(false);
  const [flyout, setFlyout] = useState13(null);
  const flyoutRef = useRef9(null);
  const flyoutTriggerRef = useRef9(null);
  ...
  const sectionRefs = useRef9(t4);
  const pendingJumpRef = useRef9(null);
  let t5;
  let t6;
  if ($[6] !== jumpOpen) {
    t5 = () => {
  ...
  if ($[24] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t17 = /* @__PURE__ */ jsx18("svg", { width: 10, height: 10, viewBox: "0 0 10 10", fill: "none", "aria-hidden": true, children: /* @__PURE__ */ jsx18("path", { d: "M2 3.5 5 6.5 8 3.5", stroke: "currentColor", strokeWidth: "1.3", strokeLinecap: "round", strokeLinejoin: "round" }) });
    $[24] = t17;
  } else {
    t17 = $[24];
  }
  ...
  if ($[25] !== t14 || $[26] !== t15 || $[27] !== t16 || $[28] !== viewMenuOpen) {
    t18 = /* @__PURE__ */ jsxs14("button", { type: "button", "aria-haspopup": "menu", "aria-expanded": viewMenuOpen, "aria-label": "Change All apps view", onClick: t13, onMouseEnter: t14, onMouseLeave: _temp74, style: t15, children: [
      t16,
      t17
    ] });
    $[25] = t14;
  ...
  if ($[30] !== chooseView || $[31] !== hover || $[32] !== theme.blur || $[33] !== theme.palette.border || $[34] !== theme.palette.surface || $[35] !== theme.palette.textPrimary || $[36] !== theme.shape.small || $[37] !== view || $[38] !== viewMenuOpen) {
    t19 = viewMenuOpen ? /* @__PURE__ */ jsxs14(Fragment6, { children: [
      /* @__PURE__ */ jsx18("div", { role: "presentation", onClick: () => {
        setViewMenuOpen(false);
      }, style: {
        position: "fixed",
        inset: 0,
      ...
      /* @__PURE__ */ jsx18("div", { role: "menu", "aria-label": "All apps view", style: {
        position: "absolute",
        right: 0,
        top: "100%",
        zIndex: 2,
      ...
      }, children: ALL_VIEWS.map((v_0) => /* @__PURE__ */ jsxs14("button", { type: "button", role: "menuitemradio", "aria-checked": view === v_0, onClick: () => {
        chooseView(v_0);
      }, onMouseEnter: (e_1) => {
  ...
  let t20;
  if ($[40] !== t18 || $[41] !== t19) {
    t20 = /* @__PURE__ */ jsxs14("div", { style: t12, children: [
      t18,
      t19
    ] });
    $[40] = t18;
  ...
  let t21;
  if ($[43] !== t11 || $[44] !== t20) {
    t21 = /* @__PURE__ */ jsxs14("div", { style: t10, children: [
      t11,
      t20
    ] });
    $[43] = t11;
  ...
  const t22 = view === "category" && !jumpOpen ? /* @__PURE__ */ jsx18("div", { style: {
    display: "grid",
    gridTemplateColumns: "repeat(3, 1fr)",
    gap: 12,
    alignContent: "start",
    paddingTop: 4
  }, children: categories.map((cat) => /* @__PURE__ */ jsxs14("button", { type: "button", onClick: (e_3) => {
  ...
  const t23 = flyout ? /* @__PURE__ */ jsxs14(Fragment6, { children: [
    /* @__PURE__ */ jsx18("div", { role: "presentation", onClick: closeFlyout, style: {
      position: "fixed",
      inset: 0,
      zIndex: 1401,
    ...
    /* @__PURE__ */ jsxs14("div", { ref: flyoutRef, role: "dialog", "aria-modal": "true", "aria-label": flyout, tabIndex: -1, onKeyDown: (e_6) => {
      if (e_6.key === "Escape") {
        e_6.stopPropagation();
        closeFlyout();
      }
      ...
      /* @__PURE__ */ jsx18("div", { style: {
        ...
        gap: 8,
        alignContent: "start"
      }, children: flyoutItems.map((result) => /* @__PURE__ */ jsx18("div", { style: {
        width: 116,
        flexShrink: 0
      }, children: /* @__PURE__ */ jsx18(LauncherTile, { result, size: 48, plain: true, onActivate: () => {
        flyoutTriggerRef.current = null;
        setFlyout(null);
        onActivate(result);
      } }) }, `cat:${result.key}`)) })
  ...
  const t24 = view === "category" ? null : jumpOpen ? /* @__PURE__ */ jsx18("div", { style: {
    display: "grid",
    gridTemplateColumns: "repeat(7, 1fr)",
    gap: 4,
    padding: "8px 0"
  }, children: ALL_ALPHABET.map((letter_0) => /* @__PURE__ */ jsx18("button", { type: "button", disabled: !present.has(letter_0), onClick: () => {
    ...
    fontWeight: 600,
    fontFamily: "inherit"
  }, children: letter_0 }, letter_0)) }) : groups.map((group) => /* @__PURE__ */ jsxs14("div", { ref: (el) => {
    if (el) {
    ...
    /* @__PURE__ */ jsx18("button", { type: "button", "aria-label": `Jump from ${group.letter}`, onClick: () => {
      setJumpOpen(true);
    }, onMouseEnter: (e_9) => {
    ...
    view === "grid" ? /* @__PURE__ */ jsx18("div", { style: {
      display: "grid",
      gridTemplateColumns: "repeat(6, 1fr)",
      gap: 4,
      justifyItems: "center",
      alignContent: "start"
    }, children: group.items.map((result_0) => /* @__PURE__ */ jsx18(LauncherTile, { result: result_0, size: 36, plain: true, onActivate: () => {
      onActivate(result_0);
    } }, `all:${result_0.key}`)) }) : /* @__PURE__ */ jsx18("div", { style: {
      display: "flex",
      flexDirection: "column",
      gap: 2
    }, children: group.items.map((result_1) => /* @__PURE__ */ jsx18(MenuRow, { result: result_1, onActivate: () => {
      onActivate(result_1);
    } }, `all:${result_1.key}`)) })
  ] }, group.letter));
  let t25;
  if ($[46] !== t21 || $[47] !== t22 || $[48] !== t23 || $[49] !== t24 || $[50] !== t9) {
    t25 = /* @__PURE__ */ jsxs14(Fragment6, { children: [
      t9,
      t21,
      t22,
      t23,
...
function _temp94(item_0) {
  return /* @__PURE__ */ jsx18("span", { style: {
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    overflow: "hidden"
  }, children: /* @__PURE__ */ jsx18(ResultMiniIcon, { result: item_0, size: 36 }) }, item_0.key);
}
...
function MenuSectionHeader(t0) {
  ...
  let t3;
  if ($[3] !== label || $[4] !== t2) {
    t3 = /* @__PURE__ */ jsx18("span", { style: t2, children: label });
    $[3] = label;
    $[4] = t2;
    $[5] = t3;
  } else {
  ...
  if ($[6] !== action || $[7] !== hover || $[8] !== theme.palette.textSecondary || $[9] !== theme.shape) {
    t4 = action ? /* @__PURE__ */ jsxs14("button", { type: "button", onClick: action.onClick, onMouseEnter: (e) => {
      e.currentTarget.style.background = hover;
  ...
  let t5;
  if ($[11] !== t3 || $[12] !== t4) {
    t5 = /* @__PURE__ */ jsxs14("div", { style: t1, children: [
      t3,
      t4
    ] });
    $[11] = t3;
...
function MenuFooterButton(t0) {
  ...
  if ($[5] !== ariaLabel || $[6] !== children || $[7] !== onClick || $[8] !== t1 || $[9] !== t2) {
    t3 = /* @__PURE__ */ jsx18("button", { type: "button", "aria-label": ariaLabel, onClick, onMouseEnter: t1, onMouseLeave: _temp112, style: t2, children });
    $[5] = ariaLabel;
    $[6] = children;
    $[7] = onClick;
    $[8] = t1;
...
function PowerButton(t0) {
  ...
  const theme = useTheme();
  const [open2, setOpen] = useState13(false);
  const btnRef = useRef9(null);
  const firstItemRef = useRef9(null);
  const hover = `${theme.palette.textPrimary}14`;
  let t1;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
  ...
  if ($[6] !== hover || $[7] !== onAction || $[8] !== open2 || $[9] !== theme.blur || $[10] !== theme.palette.border || $[11] !== theme.palette.surface || $[12] !== theme.palette.textPrimary || $[13] !== theme.shape.small) {
    t6 = open2 ? /* @__PURE__ */ jsxs14(Fragment6, { children: [
      /* @__PURE__ */ jsx18("div", { role: "presentation", onClick: () => {
        setOpen(false);
      }, style: {
        position: "fixed",
      ...
      /* @__PURE__ */ jsx18("div", { role: "menu", "aria-label": "Power", onKeyDown: (e) => {
        if (e.key === "Escape") {
          e.stopPropagation();
          close();
        }
        ...
        borderRadius: theme.shape.small,
        boxShadow: "0 12px 28px -10px rgba(0,0,0,0.5)"
      }, children: items3.map((label, i) => /* @__PURE__ */ jsx18("button", { ref: i === 0 ? firstItemRef : void 0, type: "button", role: "menuitem", onClick: () => {
        notify2({
          title: label,
  ...
  let t10;
  if ($[21] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t10 = /* @__PURE__ */ jsxs14("svg", { width: 17, height: 17, viewBox: "0 0 16 16", fill: "none", "aria-hidden": true, children: [
      /* @__PURE__ */ jsx18("path", { d: "M8 1.5v6", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
      /* @__PURE__ */ jsx18("path", { d: "M4.4 3.6a5 5 0 1 0 7.2 0", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" })
    ] });
    $[21] = t10;
  } else {
    t10 = $[21];
  ...
  if ($[22] !== open2 || $[23] !== t8 || $[24] !== t9) {
    t11 = /* @__PURE__ */ jsx18("button", { ref: btnRef, type: "button", "aria-label": "Power", "aria-haspopup": "menu", "aria-expanded": open2, onClick: t7, onMouseEnter: t8, onMouseLeave: _temp142, style: t9, children: t10 });
    $[22] = open2;
    $[23] = t8;
    $[24] = t9;
    $[25] = t11;
  ...
  let t12;
  if ($[26] !== t11 || $[27] !== t6) {
    t12 = /* @__PURE__ */ jsxs14("div", { style: t5, children: [
      t6,
      t11
    ] });
    $[26] = t11;
...
function ResultGlyph(t0) {
  ...
  if ($[9] !== Art || $[10] !== Icon || $[11] !== externalIcon || $[12] !== result.name || $[13] !== size) {
    t4 = Art ? /* @__PURE__ */ jsx18(Art, { size: Math.round(size * 0.7) }) : Icon ? /* @__PURE__ */ jsx18(Icon, { size: Math.round(size * 0.5) }) : externalIcon ? externalIcon : /* @__PURE__ */ jsx18("span", { style: {
      fontWeight: 700,
  ...
  let t5;
  if ($[15] !== t3 || $[16] !== t4) {
    t5 = /* @__PURE__ */ jsx18("div", { style: t3, children: t4 });
    $[15] = t3;
    $[16] = t4;
    $[17] = t5;
  } else {
...
function MenuRow(t0) {
  ...
  let t9;
  if ($[12] !== result || $[13] !== t8) {
    t9 = /* @__PURE__ */ jsx18(ResultGlyph, { result, size: t8 });
    $[12] = result;
    $[13] = t8;
    $[14] = t9;
  } else {
  ...
  let t12;
  if ($[17] !== result.name) {
    t12 = /* @__PURE__ */ jsx18("span", { style: t11, children: result.name });
    $[17] = result.name;
    $[18] = t12;
  } else {
    t12 = $[18];
  ...
  if ($[19] !== subtitle || $[20] !== theme.palette) {
    t13 = subtitle ? /* @__PURE__ */ jsx18("span", { style: {
      fontSize: 11,
      color: theme.palette.textSecondary
  ...
  let t14;
  if ($[22] !== t12 || $[23] !== t13) {
    t14 = /* @__PURE__ */ jsxs14("div", { style: t10, children: [
      t12,
      t13
    ] });
    $[22] = t12;
  ...
  if ($[25] !== onActivate || $[26] !== t1 || $[27] !== t14 || $[28] !== t2 || $[29] !== t3 || $[30] !== t4 || $[31] !== t5 || $[32] !== t7 || $[33] !== t9) {
    t15 = /* @__PURE__ */ jsxs14("div", { id: t1, role: t2, "aria-selected": t3, onMouseEnter: t4, onMouseLeave: t5, onClick: onActivate, style: t7, children: [
      t9,
      t14
    ] });
    $[25] = onActivate;
...
function ResultRow(t0) {
  ...
  if ($[13] !== Icon || $[14] !== externalIcon || $[15] !== result.name) {
    t9 = Icon ? /* @__PURE__ */ jsx18(Icon, { size: 15 }) : externalIcon ? externalIcon : /* @__PURE__ */ jsx18("span", { style: {
      fontWeight: 700,
      fontSize: 14
    }, children: result.name.charAt(0).toUpperCase() });
    $[13] = Icon;
  ...
  let t10;
  if ($[17] !== t8 || $[18] !== t9) {
    t10 = /* @__PURE__ */ jsx18("div", { style: t8, children: t9 });
    $[17] = t8;
    $[18] = t9;
    $[19] = t10;
  } else {
  ...
  let t15;
  if ($[29] !== t13 || $[30] !== t14) {
    t15 = /* @__PURE__ */ jsx18("span", { style: t13, children: t14 });
    $[29] = t13;
    $[30] = t14;
    $[31] = t15;
  } else {
  ...
  if ($[32] !== index || $[33] !== onActivate || $[34] !== onHover || $[35] !== selected || $[36] !== t10 || $[37] !== t12 || $[38] !== t15 || $[39] !== t2 || $[40] !== t5) {
    t16 = /* @__PURE__ */ jsxs14("div", { id: t2, role: "option", "aria-selected": selected, "data-spotlight-index": index, onMouseEnter: onHover, onClick: onActivate, style: t5, children: [
      t10,
      t12,
      t15
    ] });
...
function EmptyState(t0) {
  ...
  let t4;
  if ($[5] !== t3) {
    t4 = /* @__PURE__ */ jsx18("span", { style: t2, children: t3 });
    $[5] = t3;
    $[6] = t4;
  } else {
    t4 = $[6];
  ...
  let t5;
  if ($[7] !== t1 || $[8] !== t4) {
    t5 = /* @__PURE__ */ jsx18("div", { style: t1, children: t4 });
    $[7] = t1;
    $[8] = t4;
    $[9] = t5;
  } else {
...
function HintChip(t0) {
  ...
  let t4;
  if ($[4] !== keys || $[5] !== t3) {
    t4 = /* @__PURE__ */ jsx18("kbd", { style: t3, children: keys });
    $[4] = keys;
    $[5] = t3;
    $[6] = t4;
  } else {
  ...
  let t5;
  if ($[7] !== label) {
    t5 = /* @__PURE__ */ jsx18("span", { children: label });
    $[7] = label;
    $[8] = t5;
  } else {
    t5 = $[8];
  ...
  let t6;
  if ($[9] !== t4 || $[10] !== t5) {
    t6 = /* @__PURE__ */ jsxs14("span", { style: t1, children: [
      t4,
      t5
    ] });
    $[9] = t4;
...
import { useCallback as useCallback4, useEffect as useEffect17, useRef as useRef11, useState as useState15 } from "react";
import { useWindowManager as useWindowManager8 } from "@react-ui-os/core";
...
function FolderSvg(t0) {
  ...
  let t3;
  if ($[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsxs15("linearGradient", { id: "rui-folder-body", x1: "0", y1: "0", x2: "0", y2: "1", children: [
      /* @__PURE__ */ jsx19("stop", { offset: "0%", stopColor: "#3c4658" }),
      /* @__PURE__ */ jsx19("stop", { offset: "100%", stopColor: "#1c2333" })
    ] });
    $[1] = t3;
  } else {
    t3 = $[1];
  ...
  let t7;
  if ($[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t4 = /* @__PURE__ */ jsxs15("defs", { children: [
      t3,
      /* @__PURE__ */ jsxs15("linearGradient", { id: "rui-folder-tab", x1: "0", y1: "0", x2: "0", y2: "1", children: [
        /* @__PURE__ */ jsx19("stop", { offset: "0%", stopColor: "#4a5573" }),
        /* @__PURE__ */ jsx19("stop", { offset: "100%", stopColor: "#2c364e" })
      ] })
    ] });
    t5 = /* @__PURE__ */ jsx19("path", { d: "M 6 12 L 18 12 L 22 16 L 42 16 L 42 19 L 6 19 Z", fill: "url(#rui-folder-tab)" });
    t6 = /* @__PURE__ */ jsx19("rect", { x: "6", y: "18", width: "36", height: "22", rx: "2.5", ry: "2.5", fill: "url(#rui-folder-body)", stroke: "rgba(255,255,255,0.08)", strokeWidth: "0.5" });
    t7 = /* @__PURE__ */ jsx19("path", { d: "M 7 19 L 41 19", stroke: "rgba(255,255,255,0.18)", strokeWidth: "0.6" });
    $[2] = t4;
    $[3] = t5;
    $[4] = t6;
    $[5] = t7;
  ...
  let t8;
  if ($[6] !== size) {
    t8 = /* @__PURE__ */ jsxs15("svg", { width: size, height: size, viewBox: "0 0 48 48", fill: "none", "aria-hidden": true, style: t2, children: [
      t4,
      t5,
      t6,
      t7
...
import { useEffect as useEffect16, useRef as useRef10, useState as useState14 } from "react";
...
function DesktopIcons() {
  ...
  const [visible, setVisible] = useState15(t0);
  let t1;
  if ($[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ new Set();
    $[2] = t1;
  ...
  const [selectedIds, setSelectedIds] = useState15(t1);
  ...
  const t13 = visible.length > 0 && /* @__PURE__ */ jsx20("div", { ref: listboxRef, role: "listbox", "aria-label": "Desktop icons", "aria-orientation": "vertical", "aria-multiselectable": true, "aria-activedescendant": activeId ? optionDomId(activeId) : void 0, tabIndex: 0, onKeyDown: handleKeyDown, style: {
    position: "fixed",
    top: topInset,
    right: rightInset,
    display: "flex",
    ...
    return /* @__PURE__ */ jsx20(DesktopShortcut, { systemId: systemId_1, def, selected: selectedIds.has(systemId_1), onSelect: (modifiers_0) => {
  ...
  if ($[28] !== marquee || $[29] !== theme.palette || $[30] !== theme.shape) {
    t15 = marquee && /* @__PURE__ */ jsx20("div", { "aria-hidden": true, style: {
      position: "fixed",
      left: marquee.left,
      top: marquee.top,
      width: marquee.width,
  ...
  let t16;
  if ($[32] !== t13 || $[33] !== t15) {
    t16 = /* @__PURE__ */ jsxs16(Fragment7, { children: [
      t13,
      t15
    ] });
    $[32] = t13;
...
function DesktopShortcut(t0) {
  ...
  let t9;
  if ($[14] !== Icon) {
    t9 = /* @__PURE__ */ jsx20("div", { style: t7, children: /* @__PURE__ */ jsx20(Icon, { size: t8 }) });
    $[14] = Icon;
    $[15] = t9;
  } else {
    t9 = $[15];
  ...
  let t11;
  if ($[19] !== label || $[20] !== t10) {
    t11 = /* @__PURE__ */ jsx20("span", { style: t10, children: label });
    $[19] = label;
    $[20] = t10;
    $[21] = t11;
  } else {
  ...
  if ($[22] !== handleClick || $[23] !== handleContextMenu || $[24] !== label || $[25] !== onOpen || $[26] !== selected || $[27] !== systemId || $[28] !== t11 || $[29] !== t4 || $[30] !== t6 || $[31] !== t9) {
    t12 = /* @__PURE__ */ jsxs16("div", { role: "option", id: t4, "aria-selected": selected, "data-desktop-icon-id": systemId, title: label, onClick: handleClick, onDoubleClick: onOpen, onContextMenu: handleContextMenu, style: t6, children: [
      t9,
      t11
    ] });
    $[22] = handleClick;
...
import { dismissNotification, markNotificationRead, useNotifications as useNotifications3 } from "@react-ui-os/core";
...
function NotificationToasts() {
  ...
  if ($[7] !== active4 || $[8] !== apps || $[9] !== theme.palette) {
    ...
    if ($[11] !== apps || $[12] !== theme.palette) {
      t52 = (item, idx) => {
        ...
        return /* @__PURE__ */ jsx21(Toast, { item, accent, indexFromTop: idx }, item.id);
      };
      $[11] = apps;
      $[12] = theme.palette;
      $[13] = t52;
  ...
  let t5;
  if ($[14] !== t3 || $[15] !== t4) {
    t5 = /* @__PURE__ */ jsx21("div", { role: "region", "aria-label": "Notifications", "aria-live": "polite", style: t3, children: t4 });
    $[14] = t3;
    $[15] = t4;
    $[16] = t5;
  } else {
...
function Toast(t0) {
  ...
  const theme = useTheme();
  const reducedMotion = useReducedMotion();
  const [phase, setPhase] = useState16("enter");
  ...
  useEffect18(t1, t2);
  const readTimerRef = useRef12(null);
  let t3;
  let t4;
  ...
  let t9;
  if ($[19] !== accentBar) {
    t9 = /* @__PURE__ */ jsx21("span", { style: accentBar, "aria-hidden": true });
    $[19] = accentBar;
    $[20] = t9;
  } else {
    t9 = $[20];
  ...
  if ($[22] !== accent || $[23] !== item) {
    t11 = /* @__PURE__ */ jsx21(ToastIcon, { item, accent });
    $[22] = accent;
    $[23] = item;
    $[24] = t11;
  } else {
  ...
  let t14;
  if ($[27] !== item.title) {
    t14 = /* @__PURE__ */ jsx21("div", { style: t13, children: item.title });
    $[27] = item.title;
    $[28] = t14;
  } else {
    t14 = $[28];
  ...
  if ($[29] !== item.body || $[30] !== item.bodyNode || $[31] !== theme.palette.textSecondary) {
    t15 = (item.body || item.bodyNode) && /* @__PURE__ */ jsx21("div", { style: {
      marginTop: 2,
      fontSize: 12,
      lineHeight: 1.4,
      color: theme.palette.textSecondary,
  ...
  if ($[33] !== accent || $[34] !== item.actions || $[35] !== item.id || $[36] !== theme.palette.border || $[37] !== theme.palette.textPrimary || $[38] !== theme.shape.small) {
    t16 = item.actions && item.actions.length > 0 && /* @__PURE__ */ jsx21("div", { style: {
      marginTop: 10,
      display: "flex",
      gap: 8,
      flexWrap: "wrap"
    }, children: item.actions.map((action) => /* @__PURE__ */ jsx21("button", { type: "button", onClick: () => {
  ...
  if ($[40] !== t14 || $[41] !== t15 || $[42] !== t16) {
    t17 = /* @__PURE__ */ jsxs17("div", { style: t12, children: [
      t14,
      t15,
      t16
    ] });
  ...
  let t18;
  if ($[44] !== item.id) {
    t18 = () => dismissNotification(item.id);
    $[44] = item.id;
    $[45] = t18;
  } else {
    t18 = $[45];
  ...
  if ($[46] !== t18 || $[47] !== theme.palette.textSecondary) {
    t19 = /* @__PURE__ */ jsx21(DismissButton, { onClick: t18, color: theme.palette.textSecondary });
    $[46] = t18;
  ...
  if ($[49] !== t11 || $[50] !== t17 || $[51] !== t19) {
    t20 = /* @__PURE__ */ jsxs17("div", { style: t10, children: [
      t11,
      t17,
      t19
    ] });
  ...
  if ($[53] !== card || $[54] !== t20 || $[55] !== t9) {
    t21 = /* @__PURE__ */ jsxs17("div", { style: card, role: "status", children: [
      t9,
      t20
    ] });
    $[53] = card;
...
function ToastIcon(t0) {
  ...
  if ($[0] !== IconComp || $[1] !== item) {
    t1 = IconComp ? /* @__PURE__ */ jsx21(IconComp, { size: 16 }) : /* @__PURE__ */ jsx21("span", { style: {
      fontSize: 12,
      fontWeight: 700
  ...
  let t6;
  if ($[8] !== content || $[9] !== t5) {
    t6 = /* @__PURE__ */ jsx21("div", { "aria-hidden": true, style: t5, children: content });
    $[8] = content;
    $[9] = t5;
    $[10] = t6;
  } else {
...
function DismissButton(t0) {
  ...
  let t2;
  if ($[2] !== onClick || $[3] !== t1) {
    t2 = /* @__PURE__ */ jsx21("button", { type: "button", onClick, "aria-label": "Dismiss notification", style: t1, onMouseEnter: _temp30, onMouseLeave: _temp210, children: "\xD7" });
    $[2] = onClick;
    $[3] = t1;
    $[4] = t2;
  } else {
...
import { clearAllNotifications, markAllNotificationsRead as markAllNotificationsRead2, removeNotification, useNotifications as useNotifications4 } from "@react-ui-os/core";
...
function NotificationCenter() {
  ...
  if ($[26] !== apps || $[27] !== backdrop || $[28] !== items3 || $[29] !== open2 || $[30] !== sheet || $[31] !== theme) {
    ...
    if ($[41] !== backdrop || $[42] !== t222) {
      t21 = /* @__PURE__ */ jsx22("div", { style: backdrop, "aria-hidden": t222, onClick: t232 });
      $[41] = backdrop;
      $[42] = t222;
      $[43] = t21;
    } else {
    ...
    if ($[46] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      ...
      t27 = /* @__PURE__ */ jsx22("strong", { style: {
        fontSize: 13
    ...
    let t30;
    if ($[50] !== t28 || $[51] !== t29) {
      t30 = /* @__PURE__ */ jsxs18("div", { style: t26, children: [
        t27,
        /* @__PURE__ */ jsx22("span", { style: t28, children: t29 })
      ] });
      $[50] = t28;
      $[51] = t29;
      $[52] = t30;
    ...
    if ($[53] !== items3.length || $[54] !== theme.palette.border || $[55] !== theme.palette.textSecondary || $[56] !== theme.shape) {
      t31 = items3.length > 0 && /* @__PURE__ */ jsx22("button", { type: "button", onClick: clearAllNotifications, style: {
        appearance: "none",
        background: "transparent",
        border: `1px solid ${theme.palette.border}`,
        color: theme.palette.textSecondary,
    ...
    if ($[58] !== t25 || $[59] !== t30 || $[60] !== t31) {
      t20 = /* @__PURE__ */ jsxs18("header", { style: t25, children: [
        t30,
        t31
      ] });
      $[58] = t25;
    ...
    t15 = items3.length === 0 ? /* @__PURE__ */ jsx22(EmptyState2, { theme }) : grouped2.map((t33) => {
      const [label, group] = t33;
      return /* @__PURE__ */ jsxs18("section", { style: {
        marginBottom: 18
      }, children: [
        /* @__PURE__ */ jsx22("h3", { style: {
          margin: "0 6px 6px",
          fontSize: 10,
          letterSpacing: 0.6,
          textTransform: "uppercase",
        ...
        /* @__PURE__ */ jsx22("div", { style: {
          ...
          flexDirection: "column",
          gap: 6
        }, children: group.map((item) => /* @__PURE__ */ jsx22(CenterRow, { item, accent: accentFor(item, apps) }, item.id)) })
      ] }, label);
    });
    $[26] = apps;
    $[27] = backdrop;
  ...
  let t22;
  if ($[64] !== t14 || $[65] !== t15) {
    t22 = /* @__PURE__ */ jsx22("div", { style: t14, children: t15 });
    $[64] = t14;
    $[65] = t15;
    $[66] = t22;
  } else {
  ...
  if ($[67] !== t16 || $[68] !== t17 || $[69] !== t18 || $[70] !== t19 || $[71] !== t20 || $[72] !== t22) {
    t23 = /* @__PURE__ */ jsxs18("aside", { style: t16, "aria-hidden": t17, "aria-label": t18, role: t19, children: [
      t20,
      t22
    ] });
    $[67] = t16;
  ...
  let t24;
  if ($[74] !== t21 || $[75] !== t23) {
    t24 = /* @__PURE__ */ jsxs18(Fragment8, { children: [
      t21,
      t23
    ] });
    $[74] = t21;
...
function EmptyState2(t0) {
  ...
  if ($[2] !== theme.palette.border || $[3] !== theme.palette.textPrimary) {
    t2 = /* @__PURE__ */ jsx22("div", { "aria-hidden": true, style: {
      width: 42,
      height: 42,
      borderRadius: 12,
      background: theme.palette.border,
  ...
  let t4;
  if ($[6] !== t1 || $[7] !== t2) {
    t4 = /* @__PURE__ */ jsxs18("div", { style: t1, children: [
      t2,
...
function CenterRow(t0) {
  ...
  let t4;
  if ($[5] !== accent) {
    t4 = /* @__PURE__ */ jsx22("span", { "aria-hidden": true, style: {
      position: "absolute",
      left: 0,
      top: 6,
      bottom: 6,
  ...
  let t7;
  if ($[9] !== item.title) {
    t7 = /* @__PURE__ */ jsx22("strong", { style: t6, children: item.title });
    $[9] = item.title;
    $[10] = t7;
  } else {
    t7 = $[10];
  ...
  let t9;
  if ($[13] !== t8 || $[14] !== time) {
    t9 = /* @__PURE__ */ jsx22("span", { style: t8, children: time });
    $[13] = t8;
    $[14] = time;
    $[15] = t9;
  } else {
  ...
  let t10;
  if ($[16] !== t7 || $[17] !== t9) {
    t10 = /* @__PURE__ */ jsxs18("div", { style: t5, children: [
      t7,
      t9
    ] });
    $[16] = t7;
  ...
  if ($[19] !== item.body || $[20] !== item.bodyNode || $[21] !== theme.palette.textSecondary) {
    t11 = (item.body || item.bodyNode) && /* @__PURE__ */ jsx22("div", { style: {
      marginTop: 2,
      color: theme.palette.textSecondary
    }, children: item.bodyNode ?? item.body });
    $[19] = item.body;
  ...
  let t12;
  if ($[23] !== item.id) {
    t12 = () => removeNotification(item.id);
    $[23] = item.id;
    $[24] = t12;
  } else {
    t12 = $[24];
  ...
  let t14;
  if ($[27] !== t12 || $[28] !== t13) {
    t14 = /* @__PURE__ */ jsx22("button", { type: "button", onClick: t12, "aria-label": "Remove notification", style: t13, onMouseEnter: _temp211, onMouseLeave: _temp39, children: "\xD7" });
    $[27] = t12;
    $[28] = t13;
    $[29] = t14;
  } else {
  ...
  if ($[30] !== t10 || $[31] !== t11 || $[32] !== t14 || $[33] !== t3 || $[34] !== t4) {
    t15 = /* @__PURE__ */ jsxs18("div", { style: t3, children: [
      t4,
      t10,
      t11,
      t14
...
import { useEffect as useEffect20, useState as useState18, useSyncExternalStore as useSyncExternalStore9 } from "react";
...
function QuickSettings() {
  ...
  const metrics = t0;
  const items3 = useSyncExternalStore9(subscribeQuickSettings, listQuickSettings, listQuickSettings);
  const [open2, setOpen] = useState18(false);
  let t1;
  let t2;
  if ($[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = () => {
  ...
  if ($[7] !== items3 || $[8] !== metrics || $[9] !== open2 || $[10] !== reducedMotion || $[11] !== theme.blur.surface || $[12] !== theme.chrome.menuBar || $[13] !== theme.elevation?.windowFocused || $[14] !== theme.motion || $[15] !== theme.palette.border || $[16] !== theme.palette.surface || $[17] !== theme.palette.textPrimary || $[18] !== theme.shape.windowRadius) {
    ...
    if ($[43] !== backdrop || $[44] !== t24) {
      t12 = /* @__PURE__ */ jsx23("div", { style: backdrop, "aria-hidden": t24, onClick: t25 });
      $[43] = backdrop;
      $[44] = t24;
      $[45] = t12;
    } else {
    ...
    t7 = "Quick settings";
    t8 = !open2;
    t9 = actions.length > 0 && /* @__PURE__ */ jsxs19("div", { style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "space-between"
    }, children: [
    ...
    t10 = sliders.length > 0 && /* @__PURE__ */ jsx23("div", { style: {
      display: "flex",
      flexDirection: "column",
      gap: 12
    }, children: sliders.map(_temp95) });
    t11 = toggles.length > 0 && /* @__PURE__ */ jsx23("div", { style: {
      display: "grid",
      gridTemplateColumns: "1fr 1fr",
      gap: 8
  ...
  if ($[46] !== t10 || $[47] !== t11 || $[48] !== t5 || $[49] !== t6 || $[50] !== t7 || $[51] !== t8 || $[52] !== t9) {
    t13 = /* @__PURE__ */ jsxs19("div", { style: t5, role: t6, "aria-label": t7, "aria-hidden": t8, children: [
      t9,
      t10,
      t11
    ] });
  ...
  let t14;
  if ($[54] !== t12 || $[55] !== t13) {
    t14 = /* @__PURE__ */ jsxs19(Fragment9, { children: [
      t12,
      t13
    ] });
    $[54] = t12;
...
function _temp05(t) {
  return /* @__PURE__ */ jsx23(ToggleTile, { item: t }, t.id);
}
function _temp95(s) {
  return /* @__PURE__ */ jsx23(SliderRow, { item: s }, s.id);
}
function _temp85(a_2) {
  return /* @__PURE__ */ jsx23(ActionButton, { item: a_2 }, a_2.id);
}
function _temp75(a_1) {
  return /* @__PURE__ */ jsx23(ActionButton, { item: a_1 }, a_1.id);
}
...
function ActionButton(t0) {
  ...
  if ($[8] !== item.icon || $[9] !== item.onClick || $[10] !== t1 || $[11] !== t3 || $[12] !== t4 || $[13] !== t5) {
    t6 = /* @__PURE__ */ jsx23("button", { type: "button", onClick: item.onClick, "aria-label": t1, style: t3, onMouseEnter: t4, onMouseLeave: t5, children: item.icon });
    $[8] = item.icon;
    $[9] = item.onClick;
    $[10] = t1;
    $[11] = t3;
  ...
  if ($[15] !== button || $[16] !== item.tooltip) {
    t7 = /* @__PURE__ */ jsx23(Tooltip, { text: item.tooltip, placement: "bottom", children: button });
    $[15] = button;
    $[16] = item.tooltip;
    $[17] = t7;
  } else {
...
function SliderRow(t0) {
  ...
  if ($[1] !== item.icon || $[2] !== theme) {
    t2 = item.icon && /* @__PURE__ */ jsx23("span", { "aria-hidden": true, style: {
      display: "inline-flex",
      color: theme.palette.textSecondary,
      flexShrink: 0
    }, children: item.icon });
  ...
  if ($[9] !== item.ariaLabel || $[10] !== t4 || $[11] !== t5) {
    t6 = /* @__PURE__ */ jsx23("div", { style: t3, children: /* @__PURE__ */ jsx23(Slider, { value: t4, min: 0, max: 100, onChange: t5, ariaLabel: item.ariaLabel, hideValue: true }) });
    $[9] = item.ariaLabel;
    $[10] = t4;
    $[11] = t5;
    $[12] = t6;
  ...
  let t7;
  if ($[13] !== t2 || $[14] !== t6) {
    t7 = /* @__PURE__ */ jsxs19("div", { style: t1, children: [
      t2,
      t6
    ] });
    $[13] = t2;
...
function ToggleTile(t0) {
  ...
  let t6;
  if ($[9] !== item.icon) {
    t6 = item.icon && /* @__PURE__ */ jsx23("span", { "aria-hidden": true, style: {
      display: "inline-flex",
      flexShrink: 0
    }, children: item.icon });
    $[9] = item.icon;
  ...
  let t9;
  if ($[13] !== item.label) {
    t9 = /* @__PURE__ */ jsx23("span", { style: t8, children: item.label });
    $[13] = item.label;
    $[14] = t9;
  } else {
    t9 = $[14];
  ...
  let t10;
  if ($[15] !== item.sublabel) {
    t10 = item.sublabel && /* @__PURE__ */ jsx23("span", { style: {
      display: "block",
      fontSize: 11,
      opacity: 0.8,
      overflow: "hidden",
  ...
  let t11;
  if ($[17] !== t10 || $[18] !== t9) {
    t11 = /* @__PURE__ */ jsxs19("span", { style: t7, children: [
      t9,
      t10
    ] });
    $[17] = t10;
  ...
  if ($[20] !== active4 || $[21] !== item.label || $[22] !== t11 || $[23] !== t4 || $[24] !== t5 || $[25] !== t6) {
    t12 = /* @__PURE__ */ jsxs19("button", { type: "button", "aria-pressed": active4, "aria-label": item.label, onClick: t4, style: t5, children: [
      t6,
      t11
    ] });
    $[20] = active4;
  ...
  if ($[27] !== fg || $[28] !== item.label || $[29] !== item.onExpand) {
    t13 = item.onExpand && /* @__PURE__ */ jsx23("button", { type: "button", "aria-label": `${item.label} details`, onClick: item.onExpand, style: {
      appearance: "none",
      border: 0,
      background: "transparent",
      alignSelf: "stretch",
      ...
      cursor: "pointer",
      color: fg
    }, children: /* @__PURE__ */ jsx23("svg", { width: 12, height: 12, viewBox: "0 0 12 12", "aria-hidden": true, fill: "none", stroke: "currentColor", strokeWidth: 1.4, children: /* @__PURE__ */ jsx23("path", { d: "M4.5 2.5 L8 6 L4.5 9.5" }) }) });
    $[27] = fg;
    $[28] = item.label;
    $[29] = item.onExpand;
    $[30] = t13;
  ...
  if ($[31] !== t12 || $[32] !== t13 || $[33] !== t3) {
    t14 = /* @__PURE__ */ jsxs19("div", { style: t3, children: [
      t12,
      t13
    ] });
    $[31] = t12;
...
import { useWindowManager as useWindowManager9 } from "@react-ui-os/core";
...
import { useCallback as useCallback5, useEffect as useEffect22, useMemo as useMemo3, useState as useState19 } from "react";
import { useWindowManager as useWindowManager10, windowIdOf as windowIdOf3 } from "@react-ui-os/core";
import { Fragment as Fragment10, jsx as jsx24, jsxs as jsxs20 } from "react/jsx-runtime";
function AppSwitcher() {
  ...
  const [open2, setOpen] = useState19(false);
  ...
  if ($[18] !== candidates || $[19] !== index || $[20] !== theme) {
    t3 = /* @__PURE__ */ jsx24(Overlay, { theme, candidates, index });
    $[18] = candidates;
    $[19] = index;
    $[20] = theme;
    $[21] = t3;
...
function Overlay(t0) {
  ...
  let t4;
  if ($[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t4 = /* @__PURE__ */ jsx24("div", { "aria-hidden": true, style: {
      position: "fixed",
      inset: 0,
  ...
  if ($[8] !== candidates || $[9] !== index || $[10] !== theme) {
    ...
    if ($[12] !== index || $[13] !== theme) {
      t72 = (app, i) => /* @__PURE__ */ jsx24(Tile, { app, focused: i === index, theme }, app.id);
      $[12] = index;
      $[13] = theme;
      $[14] = t72;
    } else {
  ...
  let t7;
  if ($[15] !== t6) {
    t7 = /* @__PURE__ */ jsx24("div", { style: t5, children: t6 });
    $[15] = t6;
    $[16] = t7;
  } else {
    t7 = $[16];
  ...
  let t10;
  if ($[19] !== t8 || $[20] !== t9) {
    t10 = /* @__PURE__ */ jsx24("div", { style: t8, children: t9 });
    $[19] = t8;
    $[20] = t9;
    $[21] = t10;
  } else {
  ...
  if ($[24] !== surface || $[25] !== t10 || $[26] !== t11 || $[27] !== t7) {
    t12 = /* @__PURE__ */ jsxs20(Fragment10, { children: [
      t4,
      /* @__PURE__ */ jsxs20("div", { role: "dialog", "aria-label": "Application switcher", style: surface, children: [
        t7,
        t10,
        t11
      ] })
...
function Tile(t0) {
  ...
  if ($[8] !== Art || $[9] !== Icon || $[10] !== app.name || $[11] !== size) {
    t5 = Art ? /* @__PURE__ */ jsx24(Art, { size: Math.round(size * 0.7) }) : Icon ? /* @__PURE__ */ jsx24(Icon, { size: Math.round(size * 0.5) }) : /* @__PURE__ */ jsx24("span", { style: {
      fontWeight: 700,
  ...
  if ($[13] !== app.name || $[14] !== t4 || $[15] !== t5) {
    t6 = /* @__PURE__ */ jsx24("div", { style: t4, title: app.name, children: t5 });
    $[13] = app.name;
    $[14] = t4;
    $[15] = t5;
    $[16] = t6;
...
import { Component, useEffect as useEffect23, useMemo as useMemo4, useRef as useRef13, useState as useState20 } from "react";
import { useWindowManager as useWindowManager11 } from "@react-ui-os/core";
...
function MissionControl() {
  ...
  const [phase, setPhase] = useState20("closed");
  const phaseRef = useRef13(phase);
  phaseRef.current = phase;
  const [keyIndex, setKeyIndex] = useState20(-1);
  ...
  const visible = useMemo4(() => windows.filter((w) => w.state !== "minimized" && w.workspaceId === activeWorkspace), [windows, activeWorkspace]);
  const visibleRef = useRef13(visible);
  ...
  return /* @__PURE__ */ jsxs21("div", { ref: dialogRef, role: "dialog", "aria-label": "Mission Control", tabIndex: -1, onClick: (e_0) => {
    ...
    /* @__PURE__ */ jsx25("div", { "aria-hidden": true, style: {
      position: "absolute",
      inset: 0,
    ...
    }, children: /* @__PURE__ */ jsxs21("div", { style: {
      display: "flex",
      flexDirection: "column",
      alignItems: "center",
      gap: "clamp(20px, 4vmin, 44px)"
    }, children: [
      state.workspaces.length > 1 ? /* @__PURE__ */ jsx25(SpacesBar, { workspaces: state.workspaces, activeId: state.activeWorkspaceId, onSwitch: switchWorkspace, onAdd: addWorkspace, windows, wallpaperSrc: theme.wallpaper.src, theme }) : null,
      visible.length === 0 ? /* @__PURE__ */ jsx25(EmptyState3, { theme, hasWindowsElsewhere: windows.some((w_0) => w_0.state !== "minimized" && w_0.workspaceId !== activeWorkspace) }) : /* @__PURE__ */ jsx25("div", { style: {
        display: "flex",
        flexWrap: "wrap",
        justifyContent: "center",
        alignItems: "center",
        gap: "clamp(16px, 2.6vmin, 34px)"
      }, children: visible.map((win_1, i) => /* @__PURE__ */ jsx25(Card, { win: win_1, apps, theme, selected: i === keyIndex, onPick: () => {
        pick(win_1);
      } }, win_1.id)) })
    ] }) })
  ] });
...
function EmptyState3(t0) {
  ...
  let t4;
  if ($[3] !== t3) {
    t4 = /* @__PURE__ */ jsx25("div", { style: t2, children: t3 });
    $[3] = t3;
    $[4] = t4;
  } else {
    t4 = $[4];
  ...
  let t7;
  if ($[7] !== t5 || $[8] !== t6) {
    t7 = /* @__PURE__ */ jsx25("div", { style: t5, children: t6 });
    $[7] = t5;
    $[8] = t6;
    $[9] = t7;
  } else {
  ...
  if ($[10] !== t1 || $[11] !== t4 || $[12] !== t7) {
    t8 = /* @__PURE__ */ jsxs21("div", { style: t1, children: [
      t4,
      t7
    ] });
    $[10] = t1;
...
function Card(t0) {
  ...
  if ($[33] !== apps || $[34] !== label || $[35] !== theme || $[36] !== win) {
    t17 = /* @__PURE__ */ jsx25(MiniWindow, { win, label, apps, theme });
    $[33] = apps;
    $[34] = label;
    $[35] = theme;
    $[36] = win;
  ...
  let t18;
  if ($[38] !== t16 || $[39] !== t17) {
    t18 = /* @__PURE__ */ jsx25("div", { ref: stageRef, "aria-hidden": true, style: t16, children: t17 });
    $[38] = t16;
    $[39] = t17;
    $[40] = t18;
  } else {
  ...
  if ($[49] !== label || $[50] !== onPick || $[51] !== t19 || $[52] !== t24) {
    t25 = /* @__PURE__ */ jsx25("button", { type: "button", id: t19, onClick: onPick, "aria-label": label, onPointerEnter: t20, onPointerLeave: t21, onFocus: t22, onBlur: t23, style: t24 });
    $[49] = label;
    $[50] = onPick;
    $[51] = t19;
    $[52] = t24;
  ...
  if ($[54] !== t14 || $[55] !== t18 || $[56] !== t25) {
    t26 = /* @__PURE__ */ jsxs21("div", { ref: frameRef, style: t14, children: [
      t18,
      t25
    ] });
    $[54] = t14;
  ...
  if ($[61] !== Icon || $[62] !== theme.palette.textSecondary) {
    t28 = Icon ? /* @__PURE__ */ jsx25("span", { style: {
      display: "inline-flex",
      flexShrink: 0,
      color: theme.palette.textSecondary
    }, children: /* @__PURE__ */ jsx25(Icon, { size: 15 }) }) : null;
    $[61] = Icon;
  ...
  let t30;
  if ($[65] !== label) {
    t30 = /* @__PURE__ */ jsx25("span", { style: t29, children: label });
    $[65] = label;
    $[66] = t30;
  } else {
    t30 = $[66];
  ...
  if ($[67] !== t27 || $[68] !== t28 || $[69] !== t30) {
    t31 = /* @__PURE__ */ jsxs21("div", { style: t27, children: [
      t28,
      t30
    ] });
    $[67] = t27;
  ...
  if ($[71] !== t26 || $[72] !== t31 || $[73] !== t9) {
    t32 = /* @__PURE__ */ jsxs21("div", { "data-mc-card": true, style: t9, children: [
      t26,
      t31
    ] });
    $[71] = t26;
...
function MiniWindow(t0) {
  ...
  let t4;
  if ($[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t4 = /* @__PURE__ */ jsx25(TrafficLights2, {});
    $[4] = t4;
  } else {
    t4 = $[4];
  }
  ...
  let t6;
  if ($[7] !== label || $[8] !== t5) {
    t6 = /* @__PURE__ */ jsx25("span", { style: t5, children: label });
    $[7] = label;
    $[8] = t5;
    $[9] = t6;
  } else {
  ...
  let t7;
  if ($[10] !== t3 || $[11] !== t6) {
    t7 = /* @__PURE__ */ jsxs21("div", { style: t3, children: [
      t4,
      t6
    ] });
    $[10] = t3;
  ...
  if ($[16] !== apps || $[17] !== label || $[18] !== theme || $[19] !== win) {
    t9 = /* @__PURE__ */ jsx25(PreviewFallback, { label, apps, win, theme });
    $[16] = apps;
    $[17] = label;
    $[18] = theme;
    $[19] = win;
  ...
  let t10;
  if ($[21] !== apps || $[22] !== win) {
    t10 = /* @__PURE__ */ jsx25(PreviewContent, { win, apps });
    $[21] = apps;
    $[22] = win;
    $[23] = t10;
  } else {
  ...
  let t11;
  if ($[24] !== t10 || $[25] !== t9) {
    t11 = /* @__PURE__ */ jsx25(PreviewBoundary, { fallback: t9, children: t10 });
    $[24] = t10;
    $[25] = t9;
    $[26] = t11;
  } else {
  ...
  let t12;
  if ($[27] !== t11 || $[28] !== t8) {
    t12 = /* @__PURE__ */ jsx25("div", { style: t8, children: t11 });
    $[27] = t11;
    $[28] = t8;
    $[29] = t12;
  } else {
  ...
  if ($[30] !== t1 || $[31] !== t12 || $[32] !== t7) {
    t13 = /* @__PURE__ */ jsxs21("div", { style: t1, children: [
      t7,
      t12
    ] });
    $[30] = t1;
...
function PreviewContent(t0) {
  ...
  if (p.kind === "app") {
    ...
    if ($[5] !== Content || $[6] !== app.id) {
      t22 = /* @__PURE__ */ jsx25(Content, { appId: app.id, focused: false });
      $[5] = Content;
      $[6] = app.id;
      $[7] = t22;
    } else {
  ...
  if ($[10] !== Content_0 || $[11] !== p.args) {
    t2 = /* @__PURE__ */ jsx25(Content_0, { focused: false, args: p.args });
    $[10] = Content_0;
    $[11] = p.args;
    $[12] = t2;
  } else {
...
function PreviewFallback(t0) {
  ...
  let t3;
  if ($[6] !== Icon || $[7] !== label) {
    t3 = Icon ? /* @__PURE__ */ jsx25(Icon, { size: 48 }) : /* @__PURE__ */ jsx25("span", { style: {
      fontSize: 44,
      fontWeight: 700,
      opacity: 0.65
...
function TrafficLights2() {
  ...
  let t1;
  if ($[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsx25("span", { "aria-hidden": true, style: {
      display: "inline-flex",
      gap: 6
...
function _temp50(color) {
  return /* @__PURE__ */ jsx25("span", { style: {
    width: 11,
    height: 11,
    borderRadius: "50%",
    background: color
...
function KeyboardHelp() {
  const $ = _c32(35);
  const theme = useTheme();
  const [open2, setOpen] = useState21(false);
  const [mac] = useState21(isMacPlatform);
  const reducedMotion = useReducedMotion();
  ...
  if ($[23] !== kbd || $[24] !== mac || $[25] !== theme.palette.textSecondary) {
    t13 = grouped().map((t142) => {
      ...
      return /* @__PURE__ */ jsxs22("section", { children: [
        ...
        items3.map((s) => /* @__PURE__ */ jsxs22("div", { style: {
          display: "flex",
          alignItems: "baseline",
          justifyContent: "space-between",
          gap: 12,
          ...
          /* @__PURE__ */ jsx26("kbd", { style: kbd, children: chordDisplay(s, mac) })
        ] }, s.id))
      ] }, group);
    });
    $[23] = kbd;
  ...
  let t14;
  if ($[27] !== t13) {
    t14 = /* @__PURE__ */ jsx26("div", { style: t12, children: t13 });
    $[27] = t13;
    $[28] = t14;
  } else {
    t14 = $[28];
  ...
  let t15;
  if ($[29] !== t10 || $[30] !== t14) {
    t15 = /* @__PURE__ */ jsxs22("div", { role: "dialog", "aria-modal": "true", "aria-label": "Keyboard shortcuts", onPointerDown: _temp214, style: t10, children: [
      t11,
      t14
    ] });
    $[29] = t10;
  ...
  let t16;
  if ($[32] !== t15 || $[33] !== t7) {
    t16 = /* @__PURE__ */ jsx26("div", { onPointerDown: t6, style: t7, children: t15 });
    $[32] = t15;
    $[33] = t7;
    $[34] = t16;
  } else {
...
function Desktop(t0) {
  ...
  let t4;
  if ($[3] !== brand) {
    t4 = /* @__PURE__ */ jsx27(MenuBar, { brand });
    $[3] = brand;
    $[4] = t4;
  } else {
    t4 = $[4];
  ...
  let t9;
  if ($[5] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t5 = /* @__PURE__ */ jsx27(DesktopIcons, {});
    t6 = /* @__PURE__ */ jsx27(SnapPreview, {});
    t7 = /* @__PURE__ */ jsx27(WindowLayer, {});
    t8 = /* @__PURE__ */ jsx27(Dock, {});
    t9 = /* @__PURE__ */ jsx27(KeyboardShortcuts, {});
    t10 = /* @__PURE__ */ jsx27(Launcher, {});
    t11 = /* @__PURE__ */ jsx27(NotificationToasts, {});
    t12 = /* @__PURE__ */ jsx27(NotificationCenter, {});
    t13 = /* @__PURE__ */ jsx27(QuickSettings, {});
    t14 = /* @__PURE__ */ jsx27(ContextMenu, {});
    t15 = /* @__PURE__ */ jsx27(AppSwitcher, {});
    t16 = /* @__PURE__ */ jsx27(MissionControl, {});
    t17 = /* @__PURE__ */ jsx27(KeyboardHelp, {});
    t18 = /* @__PURE__ */ jsx27(HudOverlay, {});
    t19 = /* @__PURE__ */ jsx27(DesktopBackdrop, {});
    $[5] = t10;
    $[6] = t11;
    $[7] = t12;
    $[8] = t13;
  ...
  let t20;
  if ($[20] !== t2 || $[21] !== t4) {
    t20 = /* @__PURE__ */ jsxs23("div", { style: t2, children: [
      t3,
      t4,
      t5,
      t6,
  ...
  if ($[23] !== apps || $[24] !== children || $[25] !== storage || $[26] !== t20 || $[27] !== theme) {
    t21 = /* @__PURE__ */ jsxs23(DesktopProvider, { apps, theme, storage, children: [
      t20,
      children
    ] });
    $[23] = apps;
...
import { useCallback as useCallback6, useEffect as useEffect25, useMemo as useMemo5, useRef as useRef14, useState as useState22 } from "react";
...
// src/FileExplorer.tsx
import { Fragment as Fragment11, jsx as jsx28, jsxs as jsxs24 } from "react/jsx-runtime";
...
function FileExplorer(t0) {
  ...
  const theme = useTheme();
  const [view, setView] = useState22(defaultView);
  const [sort, setSort] = useState22("date");
  const [dir, setDir] = useState22("desc");
  ...
  const [selectedIds, setSelectedIds] = useState22(t4);
  const [anchorId, setAnchorId] = useState22(null);
  const [renamingId, setRenamingId] = useState22(null);
  ...
  if ($[47] !== sidebar || $[48] !== theme.palette.border || $[49] !== theme.palette.textSecondary || $[50] !== theme.shape.small) {
    t18 = sidebar && sidebar.length > 0 && /* @__PURE__ */ jsx28(Sidebar, { sections: sidebar, borderColor: theme.palette.border, textSecondary: theme.palette.textSecondary, radius: theme.shape.small });
    $[47] = sidebar;
  ...
  if ($[71] !== commitRename || $[72] !== dir || $[73] !== emptyState || $[74] !== filtered || $[75] !== handleContextMenu || $[76] !== handleHeaderSort || $[77] !== handleSelect || $[78] !== onOpen || $[79] !== query || $[80] !== renamingId || $[81] !== selectedIds || $[82] !== sort || $[83] !== theme.palette.border || $[84] !== theme.palette.textSecondary || $[85] !== view) {
    t25 = filtered.length === 0 ? emptyState ?? /* @__PURE__ */ jsx28(EmptyState4, { message: query ? "No matches." : "Nothing here yet." }) : view === "icons" ? /* @__PURE__ */ jsx28(GridView2, { items: filtered, selectedIds, renamingId, onSelect: handleSelect, onOpen, onContextMenu: handleContextMenu, onCommitRename: commitRename, onCancelRename: () => {
      setRenamingId(null);
    } }) : /* @__PURE__ */ jsx28(ListView, { items: filtered, selectedIds, renamingId, sortField: sort, sortDir: dir, onSortFieldChange: handleHeaderSort, onSelect: handleSelect, onOpen, onContextMenu: handleContextMenu, onCommitRename: commitRename, onCancelRename: () => {
      setRenamingId(null);
  ...
  let t26;
  if ($[87] !== t23 || $[88] !== t25) {
    t26 = /* @__PURE__ */ jsx28("div", { onClick: t22, onContextMenu: t23, style: t24, children: t25 });
    $[87] = t23;
    $[88] = t25;
    $[89] = t26;
  } else {
  ...
  if ($[90] !== filtered.length || $[91] !== items3.length || $[92] !== selectedItems.length || $[93] !== theme.palette.border || $[94] !== theme.palette.textSecondary) {
    t27 = /* @__PURE__ */ jsx28(Footer, { count: filtered.length, total: items3.length, selectedCount: selectedItems.length, themeBorder: theme.palette.border, themeTextMuted: theme.palette.textSecondary });
    $[90] = filtered.length;
    $[91] = items3.length;
  ...
  if ($[96] !== t21 || $[97] !== t26 || $[98] !== t27) {
    t28 = /* @__PURE__ */ jsxs24("div", { style: t19, children: [
      t21,
      t26,
      t27
    ] });
  ...
  if ($[100] !== actions || $[101] !== beginRename || $[102] !== dir || $[103] !== handleHeaderSort || $[104] !== items3 || $[105] !== menu || $[106] !== onOpen || $[107] !== onRename || $[108] !== selectedItems || $[109] !== sort || $[110] !== theme.blur || $[111] !== theme.palette.border || $[112] !== theme.palette.surface || $[113] !== theme.palette.textPrimary || $[114] !== theme.palette.textSecondary || $[115] !== theme.shape.small || $[116] !== view) {
    t29 = menu && /* @__PURE__ */ jsx28(ContextMenu2, { target: menu, actions, selectedItems, renamable: Boolean(onRename) && menu.itemIds.length === 1, openable: Boolean(onOpen) && menu.itemIds.length === 1, view, sort, dir, onClose: () => {
      setMenu(null);
    }, onOpenItem: () => {
  ...
  if ($[118] !== t17 || $[119] !== t18 || $[120] !== t28 || $[121] !== t29) {
    t30 = /* @__PURE__ */ jsxs24("div", { style: t17, children: [
      t18,
      t28,
      t29
    ] });
...
function Toolbar(t0) {
  ...
  if ($[0] !== actions || $[1] !== arrow || $[2] !== onQueryChange || $[3] !== onSortDirToggle || $[4] !== onSortFieldChange || $[5] !== onViewChange || $[6] !== query || $[7] !== selectedItems || $[8] !== sortDir || $[9] !== sortField || $[10] !== themeBorder || $[11] !== themeRadius || $[12] !== themeText || $[13] !== themeTextMuted || $[14] !== view) {
    ...
    if ($[21] !== t5 || $[22] !== themeBorder || $[23] !== themeRadius || $[24] !== themeText || $[25] !== view) {
      t6 = /* @__PURE__ */ jsx28(Segmented, { themeBorder, themeText, themeRadius, options: t4, value: view, onChange: t5 });
      $[21] = t5;
      $[22] = themeBorder;
      $[23] = themeRadius;
      $[24] = themeText;
    ...
    if ($[30] !== sortField || $[31] !== t8 || $[32] !== themeBorder || $[33] !== themeRadius || $[34] !== themeText) {
      t9 = /* @__PURE__ */ jsx28(Segmented, { themeBorder, themeText, themeRadius, options: t7, value: sortField, onChange: t8 });
      $[30] = sortField;
      $[31] = t8;
      $[32] = themeBorder;
      $[33] = themeRadius;
    ...
    if ($[40] !== arrow || $[41] !== onSortDirToggle || $[42] !== t10 || $[43] !== t12) {
      t13 = /* @__PURE__ */ jsx28("button", { type: "button", onClick: onSortDirToggle, title: t10, style: t12, children: arrow });
      $[40] = arrow;
      $[41] = onSortDirToggle;
      $[42] = t10;
      $[43] = t12;
    ...
    if ($[51] !== query || $[52] !== t14 || $[53] !== t16) {
      t17 = /* @__PURE__ */ jsx28("input", { type: "search", placeholder: "Search", value: query, onChange: t14, style: t16 });
      $[51] = query;
      $[52] = t14;
      $[53] = t16;
      $[54] = t17;
    ...
    if ($[55] !== selectedItems.length || $[56] !== themeTextMuted) {
      t18 = selectedItems.length > 0 && /* @__PURE__ */ jsxs24("span", { style: {
        fontSize: 11,
    ...
    if ($[58] !== selectedItems || $[59] !== themeBorder || $[60] !== themeRadius || $[61] !== themeText) {
      t19 = (action) => /* @__PURE__ */ jsx28(ToolbarButton, { label: action.label, icon: action.icon, themeBorder, themeText, themeRadius, onClick: () => {
    ...
    if ($[63] !== selectedItems || $[64] !== themeBorder || $[65] !== themeRadius) {
      t20 = (action_0) => /* @__PURE__ */ jsx28(ToolbarButton, { label: action_0.label, icon: action_0.icon, themeBorder, themeText: "#ff6868", themeRadius, onClick: () => {
    ...
    t1 = /* @__PURE__ */ jsxs24("div", { style: t3, children: [
      t6,
      t9,
      t13,
      t17,
...
function Segmented(t0) {
  ...
  if ($[3] !== onChange || $[4] !== options || $[5] !== theme || $[6] !== themeText || $[7] !== value) {
    ...
    if ($[9] !== onChange || $[10] !== theme || $[11] !== themeText || $[12] !== value) {
      t42 = (opt) => {
        ...
        return /* @__PURE__ */ jsx28("button", { type: "button", onClick: () => {
          onChange(opt.value);
        }, style: {
          border: "none",
          padding: "4px 10px",
  ...
  let t4;
  if ($[14] !== t2 || $[15] !== t3) {
    t4 = /* @__PURE__ */ jsx28("div", { style: t2, children: t3 });
    $[14] = t2;
    $[15] = t3;
    $[16] = t4;
  } else {
...
function ToolbarButton(t0) {
  ...
  if ($[4] !== icon || $[5] !== label || $[6] !== onClick || $[7] !== t2) {
    t3 = /* @__PURE__ */ jsxs24("button", { type: "button", onClick, style: t2, children: [
      icon,
      label
    ] });
    $[4] = icon;
...
function GridView2(t0) {
  ...
  if ($[1] !== items3 || $[2] !== onCancelRename || $[3] !== onCommitRename || $[4] !== onContextMenu || $[5] !== onOpen || $[6] !== onSelect || $[7] !== renamingId || $[8] !== selectedIds || $[9] !== theme) {
    ...
    if ($[11] !== onCancelRename || $[12] !== onCommitRename || $[13] !== onContextMenu || $[14] !== onOpen || $[15] !== onSelect || $[16] !== renamingId || $[17] !== selectedIds || $[18] !== theme) {
      t32 = (item) => {
        ...
        return /* @__PURE__ */ jsxs24("div", { onClick: (e) => {
          e.stopPropagation();
          onSelect(item.id, {
          ...
          isRenaming ? /* @__PURE__ */ jsx28(RenameInput, { initial: item.name, onCommit: (name) => {
          ...
          item.kind && /* @__PURE__ */ jsx28("span", { style: {
            fontSize: 10,
            color: theme.palette.textSecondary
          }, children: item.kind })
        ] }, item.id);
  ...
  let t3;
  if ($[20] !== t2) {
    t3 = /* @__PURE__ */ jsx28("div", { style: t1, children: t2 });
    $[20] = t2;
    $[21] = t3;
  } else {
    t3 = $[21];
...
function ListView(t0) {
  ...
  if ($[7] !== headerStyle || $[8] !== t5 || $[9] !== t6) {
    t7 = /* @__PURE__ */ jsxs24("button", { type: "button", onClick: t5, style: headerStyle, children: [
      "Name",
      t6
    ] });
    $[7] = headerStyle;
  ...
  if ($[13] !== headerStyle || $[14] !== t8 || $[15] !== t9) {
    t10 = /* @__PURE__ */ jsxs24("button", { type: "button", onClick: t8, style: headerStyle, children: [
      "Kind",
      t9
    ] });
    $[13] = headerStyle;
  ...
  if ($[19] !== headerStyle || $[20] !== t11 || $[21] !== t12) {
    t13 = /* @__PURE__ */ jsxs24("button", { type: "button", onClick: t11, style: headerStyle, children: [
      "Date",
      t12
    ] });
    $[19] = headerStyle;
  ...
  if ($[23] !== t10 || $[24] !== t13 || $[25] !== t4 || $[26] !== t7) {
    t14 = /* @__PURE__ */ jsxs24("div", { style: t4, children: [
      t7,
      t10,
      t13
    ] });
  ...
  let t16;
  if ($[51] !== t14 || $[52] !== t15) {
    t16 = /* @__PURE__ */ jsxs24("div", { style: t2, children: [
      t14,
      t15
    ] });
    $[51] = t14;
...
function RenameInput(t0) {
  ...
  const theme = useTheme();
  const [value, setValue] = useState22(initial);
  ...
  if ($[14] !== handleKey || $[15] !== t5 || $[16] !== t7 || $[17] !== value) {
    t8 = /* @__PURE__ */ jsx28("input", { ref, type: "text", value, onChange: t4, onKeyDown: handleKey, onBlur: t5, onClick: _temp66, style: t7 });
    $[14] = handleKey;
    $[15] = t5;
    $[16] = t7;
    $[17] = value;
...
function ContextMenu2(t0) {
  ...
  if ($[3] !== actions || $[4] !== dir || $[5] !== isItemMenu || $[6] !== itemCount || $[7] !== onClose || $[8] !== onOpenItem || $[9] !== onRename || $[10] !== onSetSort || $[11] !== onSetView || $[12] !== openable || $[13] !== renamable || $[14] !== selectedItems || $[15] !== sort || $[16] !== target.x || $[17] !== target.y || $[18] !== themeBlur || $[19] !== themeBorder || $[20] !== themeRadius || $[21] !== themeSurface || $[22] !== themeText || $[23] !== themeTextMuted || $[24] !== view) {
    ...
    t3 = /* @__PURE__ */ jsx28("div", { onMouseDown: _temp96, style: t7, children: isItemMenu ? /* @__PURE__ */ jsxs24(Fragment11, { children: [
      openable && /* @__PURE__ */ jsx28(MenuRow2, { label: "Open", shortcut: "\u21B5", onClick: onOpenItem, themeTextMuted }),
      renamable && /* @__PURE__ */ jsx28(MenuRow2, { label: "Rename", shortcut: "F2", onClick: onRename, themeTextMuted }),
      primary.map((a_2) => /* @__PURE__ */ jsx28(MenuRow2, { label: a_2.label, icon: a_2.icon, shortcut: a_2.shortcut, onClick: () => {
        a_2.onClick(selectedItems);
        onClose();
      }, themeTextMuted }, a_2.id)),
      danger.length > 0 && /* @__PURE__ */ jsx28(MenuDivider, { color: themeBorder }),
      danger.map((a_3) => /* @__PURE__ */ jsx28(MenuRow2, { label: a_3.label, icon: a_3.icon, shortcut: a_3.shortcut, danger: true, onClick: () => {
        a_3.onClick(selectedItems);
        onClose();
      }, themeTextMuted }, a_3.id))
    ] }) : /* @__PURE__ */ jsxs24(Fragment11, { children: [
      /* @__PURE__ */ jsx28(MenuLabel, { text: "View as", themeTextMuted }),
      /* @__PURE__ */ jsx28(MenuRow2, { label: "Icons", checked: view === "icons", onClick: () => {
        onSetView("icons");
      }, themeTextMuted }),
      /* @__PURE__ */ jsx28(MenuRow2, { label: "List", checked: view === "list", onClick: () => {
        onSetView("list");
      }, themeTextMuted }),
      /* @__PURE__ */ jsx28(MenuDivider, { color: themeBorder }),
      /* @__PURE__ */ jsx28(MenuLabel, { text: "Sort by", themeTextMuted }),
      ["date", "name", "kind"].map((field) => /* @__PURE__ */ jsx28(MenuRow2, { label: field === "date" ? "Date" : field === "name" ? "Name" : "Kind", shortcut: sort === field ? dir === "asc" ? "\u2191" : "\u2193" : void 0, checked: sort === field, onClick: () => {
        onSetSort(field);
...
function MenuRow2(t0) {
  ...
  let t6;
  if ($[5] !== t5) {
    t6 = /* @__PURE__ */ jsx28("span", { style: t4, children: t5 });
    $[5] = t5;
    $[6] = t6;
  } else {
    t6 = $[6];
  ...
  let t8;
  if ($[8] !== label) {
    t8 = /* @__PURE__ */ jsx28("span", { style: t7, children: label });
    $[8] = label;
    $[9] = t8;
  } else {
    t8 = $[9];
  ...
  if ($[10] !== shortcut || $[11] !== themeTextMuted) {
    t9 = shortcut && /* @__PURE__ */ jsx28("span", { style: {
      fontSize: 11,
      color: themeTextMuted,
      fontVariantNumeric: "tabular-nums"
    }, children: shortcut });
  ...
  if ($[13] !== onClick || $[14] !== t2 || $[15] !== t3 || $[16] !== t6 || $[17] !== t8 || $[18] !== t9) {
    t10 = /* @__PURE__ */ jsxs24("button", { type: "button", onClick, style: t2, onPointerEnter: t3, onPointerLeave: _temp06, children: [
      t6,
      t8,
      t9
    ] });
...
function MenuLabel(t0) {
  ...
  let t2;
  if ($[2] !== t1 || $[3] !== text) {
    t2 = /* @__PURE__ */ jsx28("div", { style: t1, children: text });
    $[2] = t1;
    $[3] = text;
    $[4] = t2;
  } else {
...
function Sidebar(t0) {
  ...
  if ($[2] !== radius || $[3] !== sections || $[4] !== textSecondary || $[5] !== theme) {
    ...
    if ($[7] !== radius || $[8] !== textSecondary || $[9] !== theme) {
      t42 = (section) => /* @__PURE__ */ jsxs24("div", { style: {
        marginBottom: 12
      }, children: [
        /* @__PURE__ */ jsx28("div", { style: {
          fontSize: 10,
        ...
        section.items.map((item) => /* @__PURE__ */ jsxs24("button", { type: "button", onClick: item.onClick, style: {
          display: "flex",
          alignItems: "center",
          gap: 8,
          width: "100%",
...
function EmptyState4(t0) {
  ...
  let t2;
  if ($[2] !== message || $[3] !== t1) {
    t2 = /* @__PURE__ */ jsx28("div", { style: t1, children: message });
    $[2] = message;
    $[3] = t1;
    $[4] = t2;
  } else {
...
function Footer(t0) {
  ...
  if ($[3] !== base || $[4] !== sel || $[5] !== t2) {
    t3 = /* @__PURE__ */ jsxs24("div", { style: t2, children: [
      base,
      sel
    ] });
    $[3] = base;
