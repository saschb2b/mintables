...
function buildZipStore(
  ...
  for (const entry of prepared) {
    ...
    dvLocal.setUint16(12, 0x0021, true);
  ...
  for (let i = 0; i < prepared.length; i++) {
    ...
    dvCentral.setUint16(14, 0x0021, true);
    ...
    dvCentral.setUint32(42, offsets[i], true);
...
function trianglesToModelXml(triangles: TriangleMesh, appName: string): string {
